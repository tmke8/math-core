...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "Downarrow" => Token::Paren(ops::DOWNWARDS_DOUBLE_ARROW),
    ...
    "Uparrow" => Token::Paren(ops::UPWARDS_DOUBLE_ARROW),
    "Updownarrow" => Token::Paren(ops::UP_DOWN_DOUBLE_ARROW),
    "Upsilon" => Token::UprightLetter('Υ'),
    "Vdash" => Token::Operator(ops::FORCES),
    "Vert" => Token::Paren(ops::DOUBLE_VERTICAL_LINE),
    "Vvdash" => Token::Operator(ops::TRIPLE_VERTICAL_BAR_RIGHT_TURNSTILE),
    ...
    "backdprime" => Token::Operator(ops::REVERSED_DOUBLE_PRIME),
    ...
    "backslash" => Token::Paren(ops::REVERSE_SOLIDUS),
    "backtrprime" => Token::Operator(ops::REVERSED_TRIPLE_PRIME),
    ...
    "beta" => Token::Letter('β'),
    "beth" => Token::Letter('ℶ'),
    "between" => Token::Operator(ops::BETWEEN),
    ...
    "coloneqq" => Token::Operator(ops::COLON_EQUALS),
    ...
    "dblcolon" => Token::Operator(ops::PROPORTION),
    "ddag" => Token::Letter('‡'),
    ...
    "doublebarwedge" => Token::Operator(ops::LOGICAL_AND_WITH_DOUBLE_OVERBAR),
    ...
    "eqqcolon" => Token::Operator(ops::EQUALS_COLON),
    ...
    "fcmp" => Token::Operator(ops::Z_NOTATION_SCHEMA_COMPOSITION),
    ...
    "l" => Token::Letter('ł'),
    "lBrace" => Token::Paren(ops::LEFT_WHITE_CURLY_BRACKET),
    "lVert" => Token::Paren(ops::DOUBLE_VERTICAL_LINE),
    "lambda" => Token::Letter('λ'),
    "land" => Token::Operator(ops::LOGICAL_AND),
    "langle" => Token::Paren(ops::MATHEMATICAL_LEFT_ANGLE_BRACKET),
    "lbrace" => Token::Paren(ops::LEFT_CURLY_BRACKET),
    "lbrack" => Token::Paren(ops::LEFT_SQUARE_BRACKET),
    ...
    "llangle" => Token::Paren(ops::Z_NOTATION_LEFT_BINDING_BRACKET),
    ...
    "llparenthesis" => Token::Paren(ops::Z_NOTATION_LEFT_IMAGE_BRACKET),
    ...
    "nu" => Token::Letter('ν'),
    "nVDash" => Token::Operator(ops::NEGATED_DOUBLE_VERTICAL_BAR_DOUBLE_RIGHT_TURNSTILE),
    "nVdash" => Token::Operator(ops::DOES_NOT_FORCE),
    "nvDash" => Token::Operator(ops::NOT_TRUE),
    "nvdash" => Token::Operator(ops::DOES_NOT_PROVE),
    ...
    "phi" => Token::Letter('ϕ'),
    "pi" => Token::Letter('π'),
    "pitchfork" => Token::Operator(ops::PITCHFORK),
    ...
    "rBrace" => Token::Paren(ops::RIGHT_WHITE_CURLY_BRACKET),
    "rVert" => Token::Paren(ops::DOUBLE_VERTICAL_LINE),
    "rangle" => Token::Paren(ops::MATHEMATICAL_RIGHT_ANGLE_BRACKET),
    "rbrace" => Token::Paren(ops::RIGHT_CURLY_BRACKET),
    "rbrack" => Token::Paren(ops::RIGHT_SQUARE_BRACKET),
    ...
    "rq" => Token::Letter('’'),
    "rrangle" => Token::Paren(ops::Z_NOTATION_RIGHT_BINDING_BRACKET),
    "rrbracket" => Token::Paren(ops::MATHEMATICAL_RIGHT_WHITE_SQUARE_BRACKET),
    "rrparenthesis" => Token::Paren(ops::Z_NOTATION_RIGHT_IMAGE_BRACKET),
    ...
    "updownarrow" => Token::Paren(ops::UP_DOWN_ARROW),
    ...
    "VDash" => Token::Operator(ops::DOUBLE_VERTICAL_BAR_DOUBLE_RIGHT_TURNSTILE),
