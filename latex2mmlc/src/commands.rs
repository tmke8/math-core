...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "llcorner" => Token::Operator(ops::BOTTOM_LEFT_CORNER),
    ...
    "lrcorner" => Token::Operator(ops::BOTTOM_RIGHT_CORNER),
    "lt" => Token::OpLessThan,
    ...
    "ulcorner" => Token::Operator(ops::TOP_LEFT_CORNER),
    ...
    "uranus" => Token::Letter('♅'),
    "urcorner" => Token::Operator(ops::TOP_RIGHT_CORNER),
