...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "ell" => Token::Letter('ℓ'),
    "empty" => Token::PseudoOperator("∅︀"), // these are two unicode characters
    "emptyset" => Token::PseudoOperator("∅︀"), // these are two unicode characters
    "end" => Token::End,
...
static TEXT_COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "^" => Token::TextModeAccent(symbol::COMBINING_CIRCUMFLEX_ACCENT.as_char()),
    ...
    "v" => Token::TextModeAccent(symbol::COMBINING_CARON.as_char()),
    "{" => Token::Delimiter(symbol::LEFT_CURLY_BRACKET),
    "|" => Token::Delimiter(symbol::DOUBLE_VERTICAL_LINE),
    "}" => Token::Delimiter(symbol::RIGHT_CURLY_BRACKET),
    "~" => Token::TextModeAccent(symbol::COMBINING_TILDE.as_char()),
};
