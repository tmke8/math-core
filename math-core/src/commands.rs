...
use mathml_renderer::attribute::{
    FracAttr, MathSpacing, MathVariant, RowAttr, Size, Style, TextTransform,
};
...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "a" => Token::Letter('å'),
    "acute" => Token::Accent(symbol::COMBINING_ACUTE_ACCENT),
    "ae" => Token::Letter('æ'),
    ...
    "bar" => Token::Accent(symbol::COMBINING_MACRON),
    ...
    "breve" => Token::Accent(symbol::COMBINING_BREVE),
    ...
    "check" => Token::Accent(symbol::COMBINING_CARON),
    ...
    "ddot" => Token::Accent(symbol::COMBINING_DIAERESIS),
    "ddots" => Token::Relation(symbol::DOWN_RIGHT_DIAGONAL_ELLIPSIS),
    "dddot" => Token::Accent(symbol::COMBINING_THREE_DOTS_ABOVE),
    "ddddot" => Token::Accent(symbol::COMBINING_FOUR_DOTS_ABOVE),
    ...
    "dj" => Token::Letter('đ'),
    "dot" => Token::Accent(symbol::COMBINING_DOT_ABOVE),
    ...
    "grave" => Token::Accent(symbol::COMBINING_GRAVE_ACCENT),
    ...
    "hat" => Token::Accent(symbol::COMBINING_CIRCUMFLEX_ACCENT),
    "hbar" => Token::Letter('ℏ'),
    ...
    "overbar" => Token::Accent(symbol::COMBINING_OVERLINE),
    ...
    "overleftarrow" => Token::OverUnder(symbol::LEFTWARDS_ARROW.as_op(), true),
    "overline" => Token::OverUnder(symbol::OVERLINE, true),
    "overparen" => Token::OverUnderBrace(symbol::TOP_PARENTHESIS, true),
    "overrightarrow" => Token::OverUnder(symbol::RIGHTWARDS_ARROW.as_op(), true),
    ...
    "tilde" => Token::Accent(symbol::COMBINING_TILDE),
    ...
    "underline" => Token::OverUnder(symbol::LOW_LINE, false), // check in the PDF
    ...
    "vec" => Token::Accent(symbol::COMBINING_RIGHT_ARROW_ABOVE),
    ...
    "widehat" => Token::OverUnder(symbol::CIRCUMFLEX_ACCENT, true),
    "widetilde" => Token::OverUnder(symbol::TILDE, true),
    "wp" => Token::Function("℘"),
