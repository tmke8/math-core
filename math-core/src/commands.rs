...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "argmax" => Token::Lim("arg max"),
    "argmin" => Token::Lim("arg min"),
...
static TEXT_COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    "Alpha" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_ALPHA),
    "Beta" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_BETA),
    "Chi" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_CHI),
    "Delta" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_DELTA),
    "Epsilon" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_EPSILON),
    "Eta" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_ETA),
    "Gamma" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_GAMMA),
    "Iota" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_IOTA),
    "Kappa" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_KAPPA),
    "Lambda" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_LAMBDA),
    "Mu" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_MU),
    "Nu" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_NU),
    "Omega" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_OMEGA),
    "Omicron" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_OMICRON),
    "Phi" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_PHI),
    "Pi" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_PI),
    "Psi" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_PSI),
    "Rho" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_RHO),
    "Sigma" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_SIGMA),
    "Tau" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_TAU),
    "Theta" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_THETA),
    "Upsilon" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_UPSILON),
    "Xi" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_XI),
    "Zeta" => Token::Letter(symbol::GREEK_CAPITAL_LETTER_ZETA),
    "\"" => Token::Letter(symbol::COMBINING_DIAERESIS),
    ...
    "epsilon" => Token::Letter(symbol::GREEK_SMALL_LETTER_EPSILON),
    ...
    "phi" => Token::Letter(symbol::GREEK_SMALL_LETTER_PHI),
