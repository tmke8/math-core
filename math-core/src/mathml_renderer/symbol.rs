...
pub const UPWARDS_ARROW: &Fence = &Fence('↑', false, Stretchy::AlwaysAsymmetric);
pub const RIGHTWARDS_ARROW: Rel = Rel('→');
pub const DOWNWARDS_ARROW: &Fence = &Fence('↓', false, Stretchy::AlwaysAsymmetric);
pub const LEFT_RIGHT_ARROW: Rel = Rel('↔');
pub const UP_DOWN_ARROW: &Fence = &Fence('↕', false, Stretchy::AlwaysAsymmetric);
...
pub const UPWARDS_DOUBLE_ARROW: &Fence = &Fence('⇑', false, Stretchy::AlwaysAsymmetric);
pub const RIGHTWARDS_DOUBLE_ARROW: Rel = Rel('⇒');
pub const DOWNWARDS_DOUBLE_ARROW: &Fence = &Fence('⇓', false, Stretchy::AlwaysAsymmetric);
pub const LEFT_RIGHT_DOUBLE_ARROW: Rel = Rel('⇔');
pub const UP_DOWN_DOUBLE_ARROW: &Fence = &Fence('⇕', false, Stretchy::AlwaysAsymmetric);
