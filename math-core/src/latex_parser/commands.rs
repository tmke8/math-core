...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "Big" => Token::Big(Size::Scale2, None),
    "Bigg" => Token::Big(Size::Scale4, None),
    "Biggl" => Token::Big(Size::Scale4, Some(Class::Open)),
    "Biggr" => Token::Big(Size::Scale4, Some(Class::Close)),
    "Bigl" => Token::Big(Size::Scale2, Some(Class::Open)),
    "Bigr" => Token::Big(Size::Scale2, Some(Class::Close)),
    ...
    "Downarrow" => Token::Relation(symbol::DOWNWARDS_DOUBLE_ARROW),
    ...
    "Uparrow" => Token::Relation(symbol::UPWARDS_DOUBLE_ARROW),
    "Updownarrow" => Token::Relation(symbol::UP_DOWN_DOUBLE_ARROW),
    ...
    "Vert" => Token::Ord(symbol::DOUBLE_VERTICAL_LINE),
    ...
    "backslash" => Token::Ord(symbol::REVERSE_SOLIDUS),
    ...
    "big" => Token::Big(Size::Scale1, None),
    ...
    "bigg" => Token::Big(Size::Scale3, None),
    "biggl" => Token::Big(Size::Scale3, Some(Class::Open)),
    "biggr" => Token::Big(Size::Scale3, Some(Class::Close)),
    "bigl" => Token::Big(Size::Scale1, Some(Class::Open)),
    ...
    "bigr" => Token::Big(Size::Scale1, Some(Class::Close)),
    ...
    "lBrace" => Token::Open(symbol::LEFT_WHITE_CURLY_BRACKET),
    "lVert" => Token::Ord(symbol::DOUBLE_VERTICAL_LINE),
    "lambda" => Token::Letter(symbol::GREEK_SMALL_LETTER_LAMBDA),
    "land" => Token::BinaryOp(symbol::LOGICAL_AND),
    "langle" => Token::Open(symbol::MATHEMATICAL_LEFT_ANGLE_BRACKET),
    ...
    "lfloor" => Token::Open(symbol::LEFT_FLOOR),
    "lgroup" => Token::Open(symbol::MATHEMATICAL_LEFT_FLATTENED_PARENTHESIS),
    ...
    "llangle" => Token::Open(symbol::Z_NOTATION_LEFT_BINDING_BRACKET),
    "llbracket" => Token::Open(symbol::MATHEMATICAL_LEFT_WHITE_SQUARE_BRACKET),
    "llcorner" => Token::Letter(symbol::BOTTOM_LEFT_CORNER),
    "lll" => Token::Relation(symbol::VERY_MUCH_LESS_THAN),
    "llparenthesis" => Token::Open(symbol::Z_NOTATION_LEFT_IMAGE_BRACKET),
    ...
    "lvert" => Token::Ord(symbol::VERTICAL_LINE),
    ...
    "rBrace" => Token::Close(symbol::RIGHT_WHITE_CURLY_BRACKET),
    "rVert" => Token::Ord(symbol::DOUBLE_VERTICAL_LINE),
    "rangle" => Token::Close(symbol::MATHEMATICAL_RIGHT_ANGLE_BRACKET),
    "rbrace" => Token::Close(symbol::RIGHT_CURLY_BRACKET),
    "rbrack" => Token::Close(symbol::RIGHT_SQUARE_BRACKET),
    "rceil" => Token::Close(symbol::RIGHT_CEILING),
    "rfloor" => Token::Close(symbol::RIGHT_FLOOR),
    "rgroup" => Token::Close(symbol::MATHEMATICAL_RIGHT_FLATTENED_PARENTHESIS),
    ...
    "rq" => Token::Letter('’'),
    "rrangle" => Token::Close(symbol::Z_NOTATION_RIGHT_BINDING_BRACKET),
    "rrbracket" => Token::Close(symbol::MATHEMATICAL_RIGHT_WHITE_SQUARE_BRACKET),
    "rrparenthesis" => Token::Close(symbol::Z_NOTATION_RIGHT_IMAGE_BRACKET),
    "rtimes" => Token::Relation(symbol::RIGHT_NORMAL_FACTOR_SEMIDIRECT_PRODUCT),
    "rupee" => Token::Letter('₹'),
    "rvert" => Token::Ord(symbol::VERTICAL_LINE),
    ...
    "times" => Token::BigOp(symbol::MULTIPLICATION_SIGN),
    ...
    "uparrow" => Token::Relation(symbol::UPWARDS_ARROW),
    "updownarrow" => Token::Relation(symbol::UP_DOWN_ARROW),
    ...
    "vert" => Token::Ord(symbol::VERTICAL_LINE),
...
pub fn get_command(command: &str) -> Option<Token<'_>> {
...
pub fn get_text_command(command: &str) -> Option<Token<'_>> {
