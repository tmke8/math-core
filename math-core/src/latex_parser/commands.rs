...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "leftthreetimes" => Relation(symbol::LEFT_SEMIDIRECT_PRODUCT),
    ...
    "lt" => OpLessThan,
    "ltimes" => Relation(symbol::LEFT_NORMAL_FACTOR_SEMIDIRECT_PRODUCT),
    ...
    "rightthreetimes" => Relation(symbol::RIGHT_SEMIDIRECT_PRODUCT),
    ...
    "rtimes" => Relation(symbol::RIGHT_NORMAL_FACTOR_SEMIDIRECT_PRODUCT),
    "rupee" => Letter('₹'),
    ...
    "times" => BigOp(symbol::MULTIPLICATION_SIGN),
