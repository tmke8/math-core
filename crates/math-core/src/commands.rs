...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    " " => NonBreakingSpace,
    "#" => Letter(symbol::NUMBER_SIGN, FromAscii::False),
    "$" => Letter(symbol::DOLLAR_SIGN, FromAscii::False),
    "%" => Letter(symbol::PERCENT_SIGN, FromAscii::False),
    "&" => OpAmpersand,
    ...
    "Angstrom" => Letter(symbol::ANGSTROM_SIGN, FromAscii::False),
    "Bbbk" => Letter(TextTransform::DoubleStruck.transform('k', false), FromAscii::False),
    ...
    "Dagger" => Letter(symbol::DOUBLE_DAGGER, FromAscii::False),
    "Delta" => UprightLetter(symbol::GREEK_CAPITAL_LETTER_DELTA),
    "Diamond" => Letter(symbol::LOZENGE, FromAscii::False),
    ...
    "Finv" => Letter(symbol::TURNED_CAPITAL_F, FromAscii::False),
    "Game" => Letter(symbol::TURNED_SANS_SERIF_CAPITAL_G, FromAscii::False),
    "Gamma" => UprightLetter(symbol::GREEK_CAPITAL_LETTER_GAMMA),
    "Im" => Letter(symbol::BLACK_LETTER_CAPITAL_I, FromAscii::False),
    ...
    "N" => Letter(symbol::DOUBLE_STRUCK_CAPITAL_N, FromAscii::False),
    ...
    "P" => Letter(symbol::PILCROW_SIGN, FromAscii::False),
    ...
    "R" => Letter(symbol::DOUBLE_STRUCK_CAPITAL_R, FromAscii::False),
    "Re" => Letter(symbol::BLACK_LETTER_CAPITAL_R, FromAscii::False),
    "Reals" => Letter(symbol::DOUBLE_STRUCK_CAPITAL_R, FromAscii::False),
    ...
    "S" => Letter(symbol::SECTION_SIGN, FromAscii::False),
    ...
    "Z" => Letter(symbol::DOUBLE_STRUCK_CAPITAL_Z, FromAscii::False),
    "Zeta" => UprightLetter(symbol::GREEK_CAPITAL_LETTER_ZETA),
    "\\" => NewLine,
    "_" => Letter(symbol::LOW_LINE.as_op().as_char(), FromAscii::False),
    "acute" => Accent(symbol::ACUTE_ACCENT, true, None),
    "aleph" => Letter(symbol::ALEF_SYMBOL, FromAscii::False),
    "alpha" => Letter(symbol::GREEK_SMALL_LETTER_ALPHA, FromAscii::False),
    "amalg" => Relation(symbol::AMALGAMATION_OR_COPRODUCT),
    "angle" => Letter(symbol::ANGLE, FromAscii::False),
    ...
    "ascnode" => Letter(symbol::ASCENDING_NODE, FromAscii::False),
    "ast" => ForceBinaryOp(symbol::ASTERISK_OPERATOR.as_op()),
    "astrosun" => Letter(symbol::SUN, FromAscii::False),
    "asymp" => Relation(symbol::EQUIVALENT_TO),
    "awint" => Op(symbol::ANTICLOCKWISE_INTEGRATION),
    "backdprime" => Ord(symbol::REVERSED_DOUBLE_PRIME),
    "backepsilon" => Letter(symbol::GREEK_REVERSED_LUNATE_EPSILON_SYMBOL, FromAscii::False),
    ...
    "beta" => Letter(symbol::GREEK_SMALL_LETTER_BETA, FromAscii::False),
    "beth" => Letter(symbol::BET_SYMBOL, FromAscii::False),
    ...
    "bigcirc" => Letter(symbol::LARGE_CIRCLE, FromAscii::False),
    ...
    "bigtriangledown" => Letter(symbol::WHITE_DOWN_POINTING_TRIANGLE, FromAscii::False),
    "bigtriangleup" => Letter(symbol::WHITE_UP_POINTING_TRIANGLE, FromAscii::False),
    "biguplus" => Op(symbol::N_ARY_UNION_OPERATOR_WITH_PLUS),
    "bigvee" => Op(symbol::N_ARY_LOGICAL_OR),
    "bigwedge" => Op(symbol::N_ARY_LOGICAL_AND),
    "binom" => Binom(None),
    "blacklozenge" => Letter(symbol::BLACK_LOZENGE, FromAscii::False),
    "blacksquare" => Letter(symbol::BLACK_SQUARE, FromAscii::False),
    "blacktriangle" => Letter(symbol::BLACK_UP_POINTING_TRIANGLE, FromAscii::False),
    "blacktriangledown" => Letter(symbol::BLACK_DOWN_POINTING_TRIANGLE, FromAscii::False),
    "blacktriangleleft" => Letter(symbol::BLACK_LEFT_POINTING_TRIANGLE, FromAscii::False),
    "blacktriangleright" => Letter(symbol::BLACK_RIGHT_POINTING_TRIANGLE, FromAscii::False),
    ...
    "bot" => Letter(symbol::UP_TACK, FromAscii::False),
    ...
    "checkmark" => Letter('✓', FromAscii::False),
    "chi" => Letter(symbol::GREEK_SMALL_LETTER_CHI, FromAscii::False),
    ...
    "circledR" => Letter(symbol::CIRCLED_LATIN_CAPITAL_LETTER_R, FromAscii::False),
    "circledS" => Letter(symbol::CIRCLED_LATIN_CAPITAL_LETTER_S, FromAscii::False),
    ...
    "clubsuit" => Letter(symbol::BLACK_CLUB_SUIT, FromAscii::False),
    "colon" => Letter(symbol::COLON.as_op().as_char(), FromAscii::False),
    "coloneq" => Relation(symbol::COLON_EQUALS),
    "coloneqq" => Relation(symbol::COLON_EQUALS),
    "color" => Color,
    "complement" => Letter(symbol::COMPLEMENT.as_op().as_char(), FromAscii::False), // should be Ord, but FF has a bug
    "cong" => Relation(symbol::APPROXIMATELY_EQUAL_TO),
    "coprod" => Op(symbol::N_ARY_COPRODUCT),
    "copyright" => Letter(symbol::COPYRIGHT_SIGN, FromAscii::False),
    ...
    "dag" => Letter(symbol::DAGGER, FromAscii::False),
    "dagger" => Letter(symbol::DAGGER, FromAscii::False),
    "daleth" => Letter(symbol::DALET_SYMBOL, FromAscii::False),
    ...
    "ddag" => Letter(symbol::DOUBLE_DAGGER, FromAscii::False),
    "ddagger" => Letter(symbol::DOUBLE_DAGGER, FromAscii::False),
    ...
    "delta" => Letter(symbol::GREEK_SMALL_LETTER_DELTA, FromAscii::False),
    "dfrac" => Frac(Some(FracAttr::DisplayStyleTrue)),
    "diamond" => ForceBinaryOp(symbol::DIAMOND_OPERATOR.as_op()),
    "diamondsuit" => Letter(symbol::WHITE_DIAMOND_SUIT, FromAscii::False),
    "digamma" => Letter(symbol::GREEK_SMALL_LETTER_DIGAMMA, FromAscii::False),
    ...
    "earth" => Letter(symbol::EARTH, FromAscii::False),
    "ell" => Letter(symbol::SCRIPT_SMALL_L, FromAscii::False),
    "empty" => CustomCmd(0, &[
    ...
    "epsilon" => Letter(symbol::GREEK_LUNATE_EPSILON_SYMBOL, FromAscii::False),
    ...
    "eta" => Letter(symbol::GREEK_SMALL_LETTER_ETA, FromAscii::False),
    "eth" => Letter(symbol::LATIN_SMALL_LETTER_ETH, FromAscii::False),
    "euro" => Letter('€', FromAscii::False),
    ...
    "gimel" => Letter(symbol::GIMEL_SYMBOL, FromAscii::False),
    ...
    "hbar" => Letter(symbol::PLANCK_CONSTANT_OVER_TWO_PI, FromAscii::False),
    "heartsuit" => Letter(symbol::WHITE_HEART_SUIT, FromAscii::False),
    ...
    "imath" => Letter(symbol::LATIN_SMALL_LETTER_DOTLESS_I, FromAscii::False),
    ...
    "infty" => Letter(symbol::INFINITY, FromAscii::False),
    ...
    "iota" => Letter(symbol::GREEK_SMALL_LETTER_IOTA, FromAscii::False),
    "it" => TransformSwitch(MathVariant::Transform(TextTransform::Italic)),
    "jmath" => Letter(symbol::LATIN_SMALL_LETTER_DOTLESS_J, FromAscii::False),
    "jupiter" => Letter(symbol::JUPITER, FromAscii::False),
    "kappa" => Letter(symbol::GREEK_SMALL_LETTER_KAPPA, FromAscii::False),
    ...
    "lambda" => Letter(symbol::GREEK_SMALL_LETTER_LAMBDA, FromAscii::False),
    ...
    "llcorner" => Letter(symbol::BOTTOM_LEFT_CORNER, FromAscii::False),
    ...
    "lozenge" => Letter(symbol::LOZENGE, FromAscii::False),
    "lrcorner" => Letter(symbol::BOTTOM_RIGHT_CORNER, FromAscii::False),
    "lt" => OpLessThan,
    "ltimes" => ForceBinaryOp(symbol::LEFT_NORMAL_FACTOR_SEMIDIRECT_PRODUCT.as_op()),
    "lvert" => Open(symbol::VERTICAL_LINE),
    "maltese" => Letter(symbol::MALTESE_CROSS, FromAscii::False),
    "mapsto" => Relation(symbol::RIGHTWARDS_ARROW_FROM_BAR),
    "mars" => Letter(symbol::MALE_SIGN, FromAscii::False),
    ...
    "measuredangle" => Letter(symbol::MEASURED_ANGLE, FromAscii::False),
    "medspace" => Space(LatexUnit::Mu.length_with_unit(4.0)),
    "mercury" => Letter(symbol::MERCURY, FromAscii::False),
    "mho" => Letter(symbol::INVERTED_OHM_SIGN, FromAscii::False),
    ...
    "mspace" => CustomSpace,
    "mu" => Letter(symbol::GREEK_SMALL_LETTER_MU, FromAscii::False),
    ...
    "nu" => Letter(symbol::GREEK_SMALL_LETTER_NU, FromAscii::False),
    ...
    "omega" => Letter(symbol::GREEK_SMALL_LETTER_OMEGA, FromAscii::False),
    "omicron" => Letter(symbol::GREEK_SMALL_LETTER_OMICRON, FromAscii::False),
    ...
    "partial" => Letter(symbol::PARTIAL_DIFFERENTIAL, FromAscii::False),
    "perp" => Relation(symbol::PERPENDICULAR),
    "phi" => Letter(symbol::GREEK_PHI_SYMBOL, FromAscii::False),
    "pi" => Letter(symbol::GREEK_SMALL_LETTER_PI, FromAscii::False),
    "pitchfork" => Relation(symbol::PITCHFORK),
    "pm" => BinaryOp(symbol::PLUS_MINUS_SIGN),
    "pmod" => CustomCmd(1, &predefined::PMOD),
    "pounds" => Letter('£', FromAscii::False),
    ...
    "psi" => Letter(symbol::GREEK_SMALL_LETTER_PSI, FromAscii::False),
    ...
    "rho" => Letter(symbol::GREEK_SMALL_LETTER_RHO, FromAscii::False),
    "right" => Right,
    ...
    "rupee" => Letter('₹', FromAscii::False),
    "rvert" => Close(symbol::VERTICAL_LINE),
    "saturn" => Letter(symbol::SATURN, FromAscii::False),
    ...
    "sharp" => Letter('♯', FromAscii::False),
    "sigma" => Letter(symbol::GREEK_SMALL_LETTER_SIGMA, FromAscii::False),
    ...
    "spadesuit" => Letter(symbol::BLACK_SPADE_SUIT, FromAscii::False),
    "sphericalangle" => Letter(symbol::SPHERICAL_ANGLE, FromAscii::False),
    ...
    "square" => Letter(symbol::WHITE_SQUARE, FromAscii::False),
    "stackrel" => Overset,
    ...
    "sun" => Letter(symbol::WHITE_SUN_WITH_RAYS, FromAscii::False),
    ...
    "tag" => Tag,
    "tau" => Letter(symbol::GREEK_SMALL_LETTER_TAU, FromAscii::False),
    ...
    "th" => Letter(symbol::LATIN_SMALL_LETTER_THORN, FromAscii::False),
    "therefore" => Relation(symbol::THEREFORE),
    "theta" => Letter(symbol::GREEK_SMALL_LETTER_THETA, FromAscii::False),
    ...
    "top" => Letter(symbol::DOWN_TACK, FromAscii::False),
    "triangle" => Letter(symbol::WHITE_UP_POINTING_TRIANGLE, FromAscii::False),
    "triangledown" => Letter(symbol::WHITE_DOWN_POINTING_TRIANGLE, FromAscii::False),
    "triangleleft" => Letter(symbol::WHITE_LEFT_POINTING_TRIANGLE, FromAscii::False),
    "triangleq" => Relation(symbol::DELTA_EQUAL_TO),
    "triangleright" => Letter(symbol::WHITE_RIGHT_POINTING_TRIANGLE, FromAscii::False),
    ...
    "ulcorner" => Letter(symbol::TOP_LEFT_CORNER, FromAscii::False),
    ...
    "upsilon" => Letter(symbol::GREEK_SMALL_LETTER_UPSILON, FromAscii::False),
    "upuparrows" => Relation(symbol::UPWARDS_PAIRED_ARROWS),
    "uranus" => Letter(symbol::URANUS, FromAscii::False),
    "urcorner" => Letter(symbol::TOP_RIGHT_CORNER, FromAscii::False),
    "vDash" => Relation(symbol::TRUE),
    "varDelta" => Letter(symbol::GREEK_CAPITAL_LETTER_DELTA, FromAscii::False), // italicized
    "varGamma" => Letter(symbol::GREEK_CAPITAL_LETTER_GAMMA, FromAscii::False), // italicized
    "varLambda" => Letter(symbol::GREEK_CAPITAL_LETTER_LAMBDA, FromAscii::False), // italicized
    "varOmega" => Letter(symbol::GREEK_CAPITAL_LETTER_OMEGA, FromAscii::False), // italicized
    "varPhi" => Letter(symbol::GREEK_CAPITAL_LETTER_PHI, FromAscii::False), // italicized
    "varPi" => Letter(symbol::GREEK_CAPITAL_LETTER_PI, FromAscii::False), // italicized
    "varSigma" => Letter(symbol::GREEK_CAPITAL_LETTER_SIGMA, FromAscii::False), // italicized
    "varTheta" => Letter(symbol::GREEK_CAPITAL_LETTER_THETA, FromAscii::False), // italicized
    "varUpsilon" => Letter(symbol::GREEK_CAPITAL_LETTER_UPSILON, FromAscii::False), // italicized
    "varXi" => Letter(symbol::GREEK_CAPITAL_LETTER_XI, FromAscii::False), // italicized
    "varepsilon" => Letter(symbol::GREEK_SMALL_LETTER_EPSILON, FromAscii::False),
    "varkappa" => Letter(symbol::GREEK_KAPPA_SYMBOL, FromAscii::False),
    "varnothing" => Letter(symbol::EMPTY_SET, FromAscii::False),
    "varointclockwise" => Op(symbol::CLOCKWISE_CONTOUR_INTEGRAL),
    "varphi" => Letter(symbol::GREEK_SMALL_LETTER_PHI, FromAscii::False),
    "varpi" => Letter(symbol::GREEK_PI_SYMBOL, FromAscii::False),
    "varrho" => Letter(symbol::GREEK_RHO_SYMBOL, FromAscii::False),
    "varsigma" => Letter(symbol::GREEK_SMALL_LETTER_FINAL_SIGMA, FromAscii::False),
    "vartheta" => Letter(symbol::GREEK_THETA_SYMBOL, FromAscii::False),
    "vartriangle" => Letter(symbol::WHITE_UP_POINTING_TRIANGLE, FromAscii::False),
    ...
    "venus" => Letter(symbol::FEMALE_SIGN, FromAscii::False),
...
static TEXT_COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    " " => Letter('\u{A0}', FromAscii::False),
    "#" => Letter('#', FromAscii::False),
    "$" => Letter('$', FromAscii::False),
    "%" => Letter('%', FromAscii::False),
    "&" => InternalStringLiteral("&amp;"),
    "'" => TextModeAccent(symbol::COMBINING_ACUTE_ACCENT),
    "," => Letter('\u{2009}', FromAscii::False),
    ...
    "DH" => Letter('Ð', FromAscii::False),
    "DJ" => Letter('Ð', FromAscii::False),
    "H" => TextModeAccent(symbol::COMBINING_DOUBLE_ACUTE_ACCENT),
    "L" => Letter('Ł', FromAscii::False),
    "NG" => Letter('Ŋ', FromAscii::False),
    "O" => Letter('Ø', FromAscii::False),
    "OE" => Letter('Œ', FromAscii::False),
    ...
    "dh" => Letter('ð', FromAscii::False),
    "dj" => Letter('đ', FromAscii::False),
    "dots" => Letter(symbol::HORIZONTAL_ELLIPSIS, FromAscii::False),
    "emph" => Text(Some(HtmlTextStyle::Emphasis)),
    "i" => Letter('ı', FromAscii::False),
    "j" => Letter('ȷ', FromAscii::False),
    "l" => Letter('ł', FromAscii::False),
    "ldots" => Letter(symbol::HORIZONTAL_ELLIPSIS, FromAscii::False),
    "ng" => Letter('ŋ', FromAscii::False),
    "o" => Letter('ø', FromAscii::False),
    "oe" => Letter('œ', FromAscii::False),
    "r" => TextModeAccent(symbol::COMBINING_RING_ABOVE),
    "rq" => Letter('’', FromAscii::False),
    "ss" => Letter('ß', FromAscii::False),
    "text" => Text(None),
    "textbackslash" => Letter('\\', FromAscii::False),
    "textbf" => Text(Some(HtmlTextStyle::Bold)),
    "textit" => Text(Some(HtmlTextStyle::Italic)),
    "textrm" => Text(Some(HtmlTextStyle::Serif)),
    "textsc" => Text(Some(HtmlTextStyle::SmallCaps)),
    "textsf" => Text(Some(HtmlTextStyle::SansSerif)),
    "texttt" => Text(Some(HtmlTextStyle::Typewriter)),
    "textyen" => Letter('¥', FromAscii::False),
