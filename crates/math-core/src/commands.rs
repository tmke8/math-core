...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "&" => OpAmpersand,
    "'" => TextMode(TextToken::Accent(symbol::COMBINING_ACUTE_ACCENT.as_op().as_char())),
    ...
    "DH" => TextMode(TextToken::Letter('Ð')),
    "DJ" => TextMode(TextToken::Letter('Ð')),
    ...
    "NG" => TextMode(TextToken::Letter('Ŋ')),
    ...
    "TH" => TextMode(TextToken::Letter('Þ')),
    ...
    "\"" => TextMode(TextToken::Accent(symbol::COMBINING_DIAERESIS.as_op().as_char())),
    "\\" => NewLine,
    ...
    "`" => TextMode(TextToken::Accent(symbol::COMBINING_GRAVE_ACCENT.as_op().as_char())),
    "aa" => TextMode(TextToken::Letter('å')),
    "acute" => Accent(symbol::COMBINING_ACUTE_ACCENT, true, OpAttrs::STRETCHY_TRUE), // stretchy because of Safari
    "ae" => TextMode(TextToken::Letter('æ')),
    ...
    "breve" => Accent(symbol::COMBINING_BREVE, true, OpAttrs::STRETCHY_TRUE), // stretchy because of Safari
    ...
    "check" => Accent(symbol::COMBINING_CARON, true, OpAttrs::STRETCHY_FALSE),
    ...
    "ddddot" => Accent(symbol::COMBINING_FOUR_DOTS_ABOVE, true, OpAttrs::STRETCHY_TRUE), // stretchy because of Safari
    "dddot" => Accent(symbol::COMBINING_THREE_DOTS_ABOVE, true, OpAttrs::STRETCHY_TRUE), // stretchy because of Safari
    "ddot" => Accent(symbol::COMBINING_DIAERESIS, true, OpAttrs::STRETCHY_TRUE), // stretchy because of Safari
    ...
    "dot" => Accent(symbol::COMBINING_DOT_ABOVE, true, OpAttrs::STRETCHY_TRUE), // stretchy because of Safari
    ...
    "grave" => Accent(symbol::COMBINING_GRAVE_ACCENT, true, OpAttrs::STRETCHY_TRUE), // stretchy because of Safari
    "gt" => OpGreaterThan,
    ...
    "tilde" => Accent(symbol::COMBINING_TILDE, true, OpAttrs::STRETCHY_TRUE), // stretchy because of Safari
    ...
    "u" => TextMode(TextToken::Accent(symbol::COMBINING_BREVE.as_op().as_char())),
    ...
    "widecheck" => Accent(symbol::CARON, true, OpAttrs::STRETCHY_TRUE),
