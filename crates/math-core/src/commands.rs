...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "RR" => Letter(symbol::DOUBLE_STRUCK_CAPITAL_R, FromAscii::False),
    ...
    "overline" => OverUnder(symbol::LOW_LINE, true, None),
    ...
    "widehat" => OverUnder(symbol::COMBINING_CIRCUMFLEX_ACCENT, true, Some(OpAttr::StretchyTrue)),
