...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "aa" => TextMode(TextToken::Letter('å')),
    "acute" => Accent(symbol::COMBINING_ACUTE_ACCENT, true, OpAttrs::empty()),
    "ae" => TextMode(TextToken::Letter('æ')),
    ...
    "breve" => Accent(symbol::COMBINING_BREVE, true, OpAttrs::empty()),
    ...
    "ddot" => Accent(symbol::COMBINING_DIAERESIS, true, OpAttrs::empty()),
    ...
    "dot" => Accent(symbol::COMBINING_DOT_ABOVE, true, OpAttrs::empty()),
    ...
    "grave" => Accent(symbol::COMBINING_GRAVE_ACCENT, true, OpAttrs::empty()),
    "gt" => OpGreaterThan,
