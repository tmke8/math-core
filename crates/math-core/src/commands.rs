...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    " " => MathOrTextMode(&NonBreakingSpace, SuperChar::from_char(symbol::NO_BREAK_SPACE)),
    ...
    "&" => MathOrTextMode(&Ord(symbol::AMPERSAND), SuperChar::from_char('&')),
    "'" => TextMode(TextToken::Accent(symbol::COMBINING_ACUTE_ACCENT)),
    "," => MathOrTextMode(&Space(LatexUnit::Mu.length_with_unit(3.0)), SuperChar::from_char(symbol::THIN_SPACE)),
    "." => TextMode(TextToken::Accent(symbol::COMBINING_DOT_ABOVE)),
    ":" => MathOrTextMode(&Space(LatexUnit::Mu.length_with_unit(4.0)), SuperChar::from_char(symbol::MEDIUM_MATHEMATICAL_SPACE)),
    ";" => MathOrTextMode(&Space(LatexUnit::Mu.length_with_unit(5.0)), SuperChar::from_char(symbol::THREE_PER_EM_SPACE)),
    "=" => TextMode(TextToken::Accent(symbol::COMBINING_MACRON)),
    ">" => MathOrTextMode(&Space(LatexUnit::Mu.length_with_unit(4.0)), SuperChar::from_char(symbol::MEDIUM_MATHEMATICAL_SPACE)),
    "AA" => TextMode(TextToken::Letter(SuperChar::from_char('Å'))),
    "AE" => TextMode(TextToken::Letter(SuperChar::from_char('Æ'))),
    ...
    "Dagger" => Letter(SuperChar::from_char(symbol::DOUBLE_DAGGER), Mode::Math),
    ...
    "L" => TextMode(TextToken::Letter(SuperChar::from_char('Ł'))),
    ...
    "O" => TextMode(TextToken::Letter(SuperChar::from_char('Ø'))),
    "OE" => TextMode(TextToken::Letter(SuperChar::from_char('Œ'))),
    ...
    "bigtriangledown" => Letter(SuperChar::from_char(symbol::WHITE_DOWN_POINTING_TRIANGLE), Mode::Math),
    "bigtriangleup" => Letter(symbol::WHITE_UP_POINTING_TRIANGLE.as_op().as_superchar(), Mode::Math),
    ...
    "blacktriangleleft" => Letter(SuperChar::from_char(symbol::BLACK_LEFT_POINTING_TRIANGLE), Mode::Math),
    "blacktriangleright" => Letter(SuperChar::from_char(symbol::BLACK_RIGHT_POINTING_TRIANGLE), Mode::Math),
    ...
    "dots" => MathOrTextMode(&CustomCmd(0, &predefined::DOTS), SuperChar::from_char(symbol::HORIZONTAL_ELLIPSIS)),
    ...
    "hspace" => CustomSpace,
    "i" => TextMode(TextToken::Letter(SuperChar::from_char('ı'))),
    ...
    "j" => TextMode(TextToken::Letter(SuperChar::from_char('ȷ'))),
    ...
    "ldots" => MathOrTextMode(&CustomCmd(0, &predefined::DOTS), SuperChar::from_char(symbol::HORIZONTAL_ELLIPSIS)),
    ...
    "ss" => TextMode(TextToken::Letter(SuperChar::from_char('ß'))),
    "stackrel" => Overset,
    ...
    "text" => Text(None),
    "textasciicircum" => TextMode(TextToken::Letter(SuperChar::from_char('ˆ'))),
    "textbackslash" => TextMode(TextToken::Letter(SuperChar::from_char('\\'))),
    "textbar" => TextMode(TextToken::Letter(SuperChar::from_char('|'))),
    "textbardbl" => TextMode(TextToken::Letter(SuperChar::from_char('‖'))),
    "textbf" => Text(Some(HtmlTextStyle::Bold)),
    "textbraceleft" => TextMode(TextToken::Letter(SuperChar::from_char('{'))),
    "textbraceright" => TextMode(TextToken::Letter(SuperChar::from_char('}'))),
    "textdagger" => TextMode(TextToken::Letter(SuperChar::from_char(symbol::DAGGER))),
    "textdaggerdbl" => TextMode(TextToken::Letter(SuperChar::from_char(symbol::DOUBLE_DAGGER))),
    "textdegree" => TextMode(TextToken::Letter(SuperChar::from_char(symbol::DEGREE_SIGN))),
    "textdollar" => TextMode(TextToken::Letter(SuperChar::from_char(symbol::DOLLAR_SIGN))),
    "textellipsis" => TextMode(TextToken::Letter(SuperChar::from_char(symbol::HORIZONTAL_ELLIPSIS))),
    "textemdash" => TextMode(TextToken::Letter(SuperChar::from_char('—'))),
    "textendash" => TextMode(TextToken::Letter(SuperChar::from_char('–'))),
    "textit" => Text(Some(HtmlTextStyle::Italic)),
    "textquotedblleft" => TextMode(TextToken::Letter(SuperChar::from_char('“'))),
    "textquotedblright" => TextMode(TextToken::Letter(SuperChar::from_char(symbol::RIGHT_DOUBLE_QUOTATION_MARK))),
    "textquoteleft" => TextMode(TextToken::Letter(SuperChar::from_char(symbol::LEFT_SINGLE_QUOTATION_MARK))),
    "textquoteright" => TextMode(TextToken::Letter(SuperChar::from_char(symbol::RIGHT_SINGLE_QUOTATION_MARK))),
    "textregistered" => TextMode(TextToken::Letter(SuperChar::from_char('®'))),
    "textrm" => Text(Some(HtmlTextStyle::Serif)),
    "textsc" => Text(Some(HtmlTextStyle::SmallCaps)),
    "textsf" => Text(Some(HtmlTextStyle::SansSerif)),
    "textsterling" => TextMode(TextToken::Letter(SuperChar::from_char(symbol::POUND_SIGN))),
    "textstyle" => Style(Style::Text),
    "texttt" => Text(Some(HtmlTextStyle::Typewriter)),
    "textunderscore" => TextMode(TextToken::Letter(SuperChar::from_char('_'))),
    "textyen" => TextMode(TextToken::Letter(SuperChar::from_char(symbol::YEN_SIGN))),
    ...
    "triangle" => Letter(symbol::WHITE_UP_POINTING_TRIANGLE.as_op().as_superchar(), Mode::Math),
    "triangledown" => Letter(SuperChar::from_char(symbol::WHITE_DOWN_POINTING_TRIANGLE), Mode::Math),
    "triangleleft" => Letter(SuperChar::from_char(symbol::WHITE_LEFT_POINTING_TRIANGLE), Mode::Math),
    "trianglelefteq" => Relation(symbol::NORMAL_SUBGROUP_OF_OR_EQUAL_TO),
    "triangleq" => Relation(symbol::DELTA_EQUAL_TO),
    "triangleright" => Letter(SuperChar::from_char(symbol::WHITE_RIGHT_POINTING_TRIANGLE), Mode::Math),
    ...
    "{" => MathOrTextMode(&Open(symbol::LEFT_CURLY_BRACKET), SuperChar::from_char('{')),
    "|" => Ord(symbol::DOUBLE_VERTICAL_LINE),
    "}" => MathOrTextMode(&Close(symbol::RIGHT_CURLY_BRACKET), SuperChar::from_char('}')),
