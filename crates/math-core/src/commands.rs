...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "atop" => InfixFrac { with_line: false, delim: None },
    ...
    "brace" => InfixFrac { with_line: false, delim: Some(InfixDelim::Brace) },
    "brack" => InfixFrac { with_line: false, delim: Some(InfixDelim::Brack) },
    ...
    "choose" => InfixFrac { with_line: false, delim: Some(InfixDelim::Paren) },
    ...
    "over" => InfixFrac { with_line: true, delim: None },
