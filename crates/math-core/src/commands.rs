...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "llcorner" => ForceOpen(symbol::BOTTOM_LEFT_CORNER, ForceStretchy::No),
    ...
    "lrcorner" => ForceClose(symbol::BOTTOM_RIGHT_CORNER, ForceStretchy::No),
    ...
    "ulcorner" => ForceOpen(symbol::TOP_LEFT_CORNER, ForceStretchy::No),
    ...
    "urcorner" => ForceClose(symbol::TOP_RIGHT_CORNER, ForceStretchy::No),
