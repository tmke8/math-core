...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "Complex" => Letter(symbol::DOUBLE_STRUCK_CAPITAL_C, Mode::Math),
    ...
    "P" => Letter(symbol::PILCROW_SIGN, Mode::MathOrText),
    ...
    "S" => Letter(symbol::SECTION_SIGN, Mode::MathOrText),
    ...
    "ae" => TextMode(TextToken::Letter('æ')),
    "alef" => Letter(symbol::ALEF_SYMBOL, Mode::Math),
    "alefsym" => Letter(symbol::ALEF_SYMBOL, Mode::Math),
    ...
    "bigtriangleup" => Letter(symbol::WHITE_UP_POINTING_TRIANGLE.as_op().as_char(), Mode::Math),
    ...
    "checkmark" => Letter(symbol::CHECK_MARK, Mode::MathOrText),
    ...
    "circledR" => Letter(symbol::CIRCLED_LATIN_CAPITAL_LETTER_R, Mode::MathOrText),
    ...
    "clubs" => Letter(symbol::BLACK_CLUB_SUIT, Mode::Math),
    "clubsuit" => Letter(symbol::BLACK_CLUB_SUIT, Mode::Math),
    "cnums" => Letter(symbol::DOUBLE_STRUCK_CAPITAL_C, Mode::Math),
    ...
    "dArr" => Relation(symbol::DOWNWARDS_DOUBLE_ARROW),
    "dag" => Letter(symbol::DAGGER, Mode::MathOrText),
    ...
    "ddag" => Letter(symbol::DOUBLE_DAGGER, Mode::MathOrText),
    ...
    "degree" => Letter(symbol::DEGREE_SIGN, Mode::MathOrText),
    ...
    "diamonds" => Letter(symbol::WHITE_DIAMOND_SUIT, Mode::Math),
    ...
    "hearts" => Letter(symbol::WHITE_HEART_SUIT, Mode::Math),
    ...
    "infin" => Letter(symbol::INFINITY, Mode::Math),
    ...
    "ngeqq" => CustomCmd(0, &[Not, Relation(symbol::GREATER_THAN_OVER_EQUAL_TO)]),
    "ngeqslant" =>  CustomCmd(0, &[Not, Relation(symbol::GREATER_THAN_OR_SLANTED_EQUAL_TO)]),
    ...
    "nleqq" => CustomCmd(0, &[Not, Relation(symbol::LESS_THAN_OVER_EQUAL_TO)]),
    "nleqslant" =>  CustomCmd(0, &[Not, Relation(symbol::LESS_THAN_OR_SLANTED_EQUAL_TO)]),
    ...
    "nsubseteqq" => CustomCmd(0, &[Not, Relation(symbol::SUBSET_OF_ABOVE_EQUALS_SIGN)]),
    ...
    "nsupseteqq" => CustomCmd(0, &[Not, Relation(symbol::SUPERSET_OF_ABOVE_EQUALS_SIGN)]),
    ...
    "real" => Letter(symbol::BLACK_LETTER_CAPITAL_R, Mode::Math),
    "reals" => Letter(symbol::DOUBLE_STRUCK_CAPITAL_R, Mode::Math),
    ...
    "sect" => Letter(symbol::SECTION_SIGN, Mode::MathOrText),
    ...
    "thetasym" => Letter(symbol::GREEK_THETA_SYMBOL, Mode::Math),
    ...
    "triangle" => Letter(symbol::WHITE_UP_POINTING_TRIANGLE.as_op().as_char(), Mode::Math),
    ...
    "yen" => Letter(symbol::YEN_SIGN, Mode::MathOrText),
