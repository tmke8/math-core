...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "amalg" => BinaryOp(symbol::AMALGAMATION_OR_COPRODUCT),
    ...
    "llcorner" => ForceOpen(symbol::BOTTOM_LEFT_CORNER),
    "lll" => Relation(symbol::VERY_MUCH_LESS_THAN),
    "llless" => Relation(symbol::VERY_MUCH_LESS_THAN),
    "lmoustache" => ForceOpen(symbol::UPPER_LEFT_OR_LOWER_RIGHT_CURLY_BRACKET_SECTION),
    ...
    "lrcorner" => ForceClose(symbol::BOTTOM_RIGHT_CORNER),
    ...
    "rmoustache" => ForceClose(symbol::UPPER_RIGHT_OR_LOWER_LEFT_CURLY_BRACKET_SECTION),
    ...
    "ulcorner" => ForceOpen(symbol::TOP_LEFT_CORNER),
    ...
    "urcorner" => ForceClose(symbol::TOP_RIGHT_CORNER),
