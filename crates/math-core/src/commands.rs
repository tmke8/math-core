...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "underleftarrow" => Accent(symbol::LEFTWARDS_ARROW_ACCENT, false, OpAttrs::empty()),
    "underleftrightarrow" => Accent(symbol::LEFT_RIGHT_ARROW_ACCENT, false, OpAttrs::empty()),
    "underrightarrow" => Accent(symbol::RIGHTWARDS_ARROW_ACCENT, false, OpAttrs::empty()),
