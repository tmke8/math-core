...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "Braket" => CustomCmd(1, &predefined::BIG_BRAKET),
    ...
    "Coloneq" => CustomCmd(0, &predefined::DOUBLE_COLON_EQUAL),
    "Coloneqq" => CustomCmd(0, &predefined::DOUBLE_COLON_EQUAL),
    "Colonapprox" => CustomCmd(0, &predefined::DOUBLE_COLON_APPROX),
    "Colondash" => CustomCmd(0, &predefined::DOUBLE_COLON_MINUS),
    "Colonsim" => CustomCmd(0, &predefined::DOUBLE_COLON_SIM),
    "Complex" => Letter(SuperChar::from_char(symbol::DOUBLE_STRUCK_CAPITAL_C), Mode::Math),
    "Cup" => BinaryOp(symbol::DOUBLE_UNION),
    "Dagger" => ForceBinaryOp(symbol::DOUBLE_DAGGER),
    "Darr" => Relation(symbol::DOWNWARDS_DOUBLE_ARROW),
    "Dashcolon" => CustomCmd(0, &predefined::MINUS_DOUBLE_COLON),
    ...
    "Eqcolon" => CustomCmd(0, &predefined::EQUALS_DOUBLE_COLON),
    "Eqqcolon" => CustomCmd(0, &predefined::EQUALS_DOUBLE_COLON),
    ...
    "Overrightarrow" => Accent(symbol::RIGHTWARDS_DOUBLE_ARROW.as_bmp_op(), true, OpAttrs::empty()),
    ...
    "Set" => CustomCmd(1, &predefined::BIG_SET),
    "Sigma" => UprightLetter(SuperChar::from_char(symbol::GREEK_CAPITAL_LETTER_SIGMA)),
    "Simcolon" => CustomCmd(0, &predefined::SIM_DOUBLE_COLON),
    ...
    "\\" => NewLine,
    "^" => TextMode(TextToken::Accent(symbol::COMBINING_CIRCUMFLEX_ACCENT.as_char())),
    ...
    "angl" => Enclose(Notation::ACTUARIAL),
    "angle" => Letter(SuperChar::from_char(symbol::ANGLE), Mode::Math),
    "angln" => CustomCmd(0, &predefined::ANGLN),
    "approx" => Relation(symbol::ALMOST_EQUAL_TO),
    "approxcolon" => CustomCmd(0, &predefined::APPROX_COLON),
    "approxcoloncolon" => CustomCmd(0, &predefined::APPROX_DOUBLE_COLON),
    ...
    "blacktriangle" => Letter(SuperChar::from_char(symbol::BLACK_UP_POINTING_SMALL_TRIANGLE), Mode::Math),
    "blacktriangledown" => Letter(SuperChar::from_char(symbol::BLACK_DOWN_POINTING_SMALL_TRIANGLE), Mode::Math),
    ...
    "colonapprox" => CustomCmd(0, &predefined::COLON_APPROX),
    "coloncolon" => CustomCmd(0, &predefined::DOUBLE_COLON),
    "coloncolonapprox" => CustomCmd(0, &predefined::DOUBLE_COLON_APPROX),
    "coloncolonequals" => CustomCmd(0, &predefined::DOUBLE_COLON_EQUAL),
    "coloncolonminus" => CustomCmd(0, &predefined::DOUBLE_COLON_MINUS),
    "coloncolonsim" => CustomCmd(0, &predefined::DOUBLE_COLON_SIM),
    "colondash" => CustomCmd(0, &predefined::COLON_MINUS),
    "coloneq" => CustomCmd(0, &predefined::COLON_EQUALS),
    "colonequals" => CustomCmd(0, &predefined::COLON_EQUALS),
    "coloneqq" => CustomCmd(0, &predefined::COLON_EQUALS),
    "colonminus" => CustomCmd(0, &predefined::COLON_MINUS),
    "colonsim" => CustomCmd(0, &predefined::COLON_SIM),
    "color" => Color,
    ...
    "dArr" => Relation(symbol::DOWNWARDS_DOUBLE_ARROW),
    "dag" => Letter(symbol::DAGGER.as_superchar(), Mode::MathOrText),
    "dagger" => ForceBinaryOp(symbol::DAGGER),
    "daleth" => Letter(SuperChar::from_char(symbol::DALET_SYMBOL), Mode::Math),
    "darr" => Relation(symbol::DOWNWARDS_ARROW),
    "dashcolon" => CustomCmd(0, &predefined::MINUS_COLON),
    ...
    "dblcolon" => CustomCmd(0, &predefined::DOUBLE_COLON),
    "ddag" => Letter(symbol::DOUBLE_DAGGER.as_superchar(), Mode::MathOrText),
    "ddagger" => ForceBinaryOp(symbol::DOUBLE_DAGGER),
    ...
    "diagdown" => ForceOrd(symbol::MATHEMATICAL_FALLING_DIAGONAL.as_op()),
    "diagup" => ForceOrd(symbol::MATHEMATICAL_RISING_DIAGONAL.as_op()),
    ...
    "dots" => MathOrTextMode(&Dots, symbol::HORIZONTAL_ELLIPSIS),
    ...
    "eqcolon" => CustomCmd(0, &predefined::EQUALS_COLON),
    "eqdef" => Relation(symbol::EQUAL_TO_BY_DEFINITION), // from "stix"
    "eqqcolon" => CustomCmd(0, &predefined::EQUALS_COLON),
    "eqref" => EqRef,
    ...
    "equalscolon" => CustomCmd(0, &predefined::EQUALS_COLON),
    "equalscoloncolon" => CustomCmd(0, &predefined::EQUALS_DOUBLE_COLON),
    ...
    "iddots" => Relation(symbol::UP_RIGHT_DIAGONAL_ELLIPSIS), // from "mathdots"
    ...
    "lparen" => Open(symbol::LEFT_PARENTHESIS),
    ...
    "medspace" => MathOrTextMode(&Space(LatexUnit::Mu.length_with_unit(4.0)), symbol::MEDIUM_MATHEMATICAL_SPACE),
    "mho" => Letter(SuperChar::from_char(symbol::INVERTED_OHM_SIGN), Mode::Math),
    "mid" => Relation(symbol::DIVIDES),
    "middle" => Middle,
    "min" => PseudoOperatorLimits("min"),
    "minuscolon" => CustomCmd(0, &predefined::MINUS_COLON),
    "minuscoloncolon" => CustomCmd(0, &predefined::MINUS_DOUBLE_COLON),
    ...
    "negmedspace" => Space(LatexUnit::Mu.length_with_unit(-4.0)),
    "negthickspace" => Space(LatexUnit::Mu.length_with_unit(-5.0)),
    ...
    "overgroup" => Accent(symbol::TOP_TORTOISE_SHELL_BRACKET.as_bmp_op(), true, OpAttrs::empty()),
    "overleftarrow" => Accent(symbol::LEFTWARDS_ARROW.as_bmp_op(), true, OpAttrs::empty()),
    "overleftharpoon" => Accent(symbol::LEFTWARDS_HARPOON_WITH_BARB_UPWARDS.as_bmp_op(), true, OpAttrs::empty()),
    "overleftrightarrow" => Accent(symbol::LEFT_RIGHT_ARROW.as_bmp_op(), true, OpAttrs::empty()),
    "overline" => Accent(symbol::COMBINING_LOW_LINE, true, OpAttrs::STRETCHY_TRUE),
    "overparen" => OverUnderBrace(symbol::TOP_PARENTHESIS, true),
    "overrightarrow" => Accent(symbol::RIGHTWARDS_ARROW.as_bmp_op(), true, OpAttrs::empty()),
    "overrightharpoon" => Accent(symbol::RIGHTWARDS_HARPOON_WITH_BARB_UPWARDS.as_bmp_op(), true, OpAttrs::empty()),
    "overset" => Overset,
    ...
    "pod" => CustomCmd(1, &predefined::POD),
    ...
    "rparen" => Close(symbol::RIGHT_PARENTHESIS),
    ...
    "set" => CustomCmd(1, &predefined::SET),
    ...
    "simcoloncolon" => CustomCmd(0, &predefined::SIM_DOUBLE_COLON),
    ...
    "tag" => Tag { parenthesized: true },
    "tag*" => Tag { parenthesized: false },
    "tau" => Letter(SuperChar::from_char(symbol::GREEK_SMALL_LETTER_TAU), Mode::Math),
    "tbinom" => Binom(Some(FracAttr::DisplayStyleFalse)),
    "text" => Text(None),
    "textasciicircum" => TextMode(TextToken::Letter(symbol::MODIFIER_LETTER_CIRCUMFLEX_ACCENT.as_char())),
    "textasciitilde" => TextMode(TextToken::Letter(symbol::SMALL_TILDE.as_char())),
    ...
    "thickspace" => MathOrTextMode(&Space(LatexUnit::Mu.length_with_unit(5.0)), symbol::THREE_PER_EM_SPACE),
    "thinspace" =>  MathOrTextMode(&Space(LatexUnit::Mu.length_with_unit(3.0)), symbol::THIN_SPACE),
    ...
    "triangledown" => Letter(symbol::WHITE_DOWN_POINTING_SMALL_TRIANGLE.as_superchar(), Mode::Math),
    ...
    "underbar" => Text(Some(HtmlTextStyle::Underline)),
    ...
    "undergroup" => Accent(symbol::BOTTOM_TORTOISE_SHELL_BRACKET.as_bmp_op(), false, OpAttrs::empty()),
    "underleftarrow" => Accent(symbol::LEFTWARDS_ARROW.as_bmp_op(), false, OpAttrs::empty()),
    "underleftrightarrow" => Accent(symbol::LEFT_RIGHT_ARROW.as_bmp_op(), false, OpAttrs::empty()),
    "underrightarrow" => Accent(symbol::RIGHTWARDS_ARROW.as_bmp_op(), false, OpAttrs::empty()),
    ...
    "vartriangle" => ForceRelation(symbol::WHITE_UP_POINTING_SMALL_TRIANGLE),
...
static UNICODE_OPERATORS: phf::Map<char, Token> = phf::phf_map! {
    ...
    // `\mathop`
    '⅀' => ForceOp(symbol::DOUBLE_STRUCK_N_ARY_SUMMATION, true),
    ...
    '⟕' => ForceOp(symbol::LEFT_OUTER_JOIN, true),
    '⟖' => ForceOp(symbol::RIGHT_OUTER_JOIN, true),
    '⟗' => ForceOp(symbol::FULL_OUTER_JOIN, true),
    '⟘' => ForceOp(symbol::LARGE_UP_TACK, true),
    '⟙' => ForceOp(symbol::LARGE_DOWN_TACK, true),
    '⧸' => ForceOp(symbol::BIG_SOLIDUS.as_op(), true),
    '⧹' => ForceOp(symbol::BIG_REVERSE_SOLIDUS.as_op(), true),
    ...
    '⨝' => ForceOp(symbol::JOIN.as_op(), true),
    '⨞' => ForceOp(symbol::LARGE_LEFT_TRIANGLE_OPERATOR.as_op(), true),
    '⨟' => ForceOp(symbol::Z_NOTATION_SCHEMA_COMPOSITION.as_op(), false),
    '⨠' => ForceOp(symbol::Z_NOTATION_SCHEMA_PIPING.as_op(), false),
    '⨡' => ForceOp(symbol::Z_NOTATION_SCHEMA_PROJECTION.as_op(), false),
    '⫼' => Op(symbol::LARGE_TRIPLE_VERTICAL_BAR_OPERATOR),
    '⫿' => Op(symbol::N_ARY_WHITE_VERTICAL_BAR),
    // '\u{1EEF0}' => ForceOp(symbol::ARABIC_MATHEMATICAL_OPERATOR_MEEM_WITH_HAH_WITH_TATWEEL, true),
    // '\u{1EEF1}' => ForceOp(symbol::ARABIC_MATHEMATICAL_OPERATOR_HAH_WITH_DAL, true),
    ...
    '†' => ForceBinaryOp(symbol::DAGGER),
    '‡' => ForceBinaryOp(symbol::DOUBLE_DAGGER),
    '•' => ForceBinaryOp(symbol::BULLET),
    ...
    '⤀' => Relation(symbol::RIGHTWARDS_TWO_HEADED_ARROW_WITH_VERTICAL_STROKE),
    '⤁' => Relation(symbol::RIGHTWARDS_TWO_HEADED_ARROW_WITH_DOUBLE_VERTICAL_STROKE),
    '⤂' => Relation(symbol::LEFTWARDS_DOUBLE_ARROW_WITH_VERTICAL_STROKE),
    '⤃' => Relation(symbol::RIGHTWARDS_DOUBLE_ARROW_WITH_VERTICAL_STROKE),
    '⤄' => Relation(symbol::LEFT_RIGHT_DOUBLE_ARROW_WITH_VERTICAL_STROKE),
    '⤅' => Relation(symbol::RIGHTWARDS_TWO_HEADED_ARROW_FROM_BAR),
    '⤆' => Relation(symbol::LEFTWARDS_DOUBLE_ARROW_FROM_BAR),
    '⤇' => Relation(symbol::RIGHTWARDS_DOUBLE_ARROW_FROM_BAR),
    '⤈' => Relation(symbol::DOWNWARDS_ARROW_WITH_HORIZONTAL_STROKE),
    '⤉' => Relation(symbol::UPWARDS_ARROW_WITH_HORIZONTAL_STROKE),
    '⤊' => Relation(symbol::UPWARDS_TRIPLE_ARROW),
    '⤋' => Relation(symbol::DOWNWARDS_TRIPLE_ARROW),
    '⤌' => Relation(symbol::LEFTWARDS_DOUBLE_DASH_ARROW),
    '⤍' => Relation(symbol::RIGHTWARDS_DOUBLE_DASH_ARROW),
    '⤎' => Relation(symbol::LEFTWARDS_TRIPLE_DASH_ARROW),
    '⤏' => Relation(symbol::RIGHTWARDS_TRIPLE_DASH_ARROW),
    '⤐' => Relation(symbol::RIGHTWARDS_TWO_HEADED_TRIPLE_DASH_ARROW),
    '⤑' => Relation(symbol::RIGHTWARDS_ARROW_WITH_DOTTED_STEM),
    '⤒' => Relation(symbol::UPWARDS_ARROW_TO_BAR),
    '⤓' => Relation(symbol::DOWNWARDS_ARROW_TO_BAR),
    '⤔' => Relation(symbol::RIGHTWARDS_ARROW_WITH_TAIL_WITH_VERTICAL_STROKE),
    '⤕' => Relation(symbol::RIGHTWARDS_ARROW_WITH_TAIL_WITH_DOUBLE_VERTICAL_STROKE),
    '⤖' => Relation(symbol::RIGHTWARDS_TWO_HEADED_ARROW_WITH_TAIL),
    '⤗' => Relation(symbol::RIGHTWARDS_TWO_HEADED_ARROW_WITH_TAIL_WITH_VERTICAL_STROKE),
    '⤘' => Relation(symbol::RIGHTWARDS_TWO_HEADED_ARROW_WITH_TAIL_WITH_DOUBLE_VERTICAL_STROKE),
    '⤛' => Relation(symbol::LEFTWARDS_DOUBLE_ARROW_TAIL),
    '⤜' => Relation(symbol::RIGHTWARDS_DOUBLE_ARROW_TAIL),
    '⤝' => Relation(symbol::LEFTWARDS_ARROW_TO_BLACK_DIAMOND),
    '⤞' => Relation(symbol::RIGHTWARDS_ARROW_TO_BLACK_DIAMOND),
    '⤟' => Relation(symbol::LEFTWARDS_ARROW_FROM_BAR_TO_BLACK_DIAMOND),
    '⤠' => Relation(symbol::RIGHTWARDS_ARROW_FROM_BAR_TO_BLACK_DIAMOND),
    '⤡' => Relation(symbol::NORTH_WEST_AND_SOUTH_EAST_ARROW),
    '⤢' => Relation(symbol::NORTH_EAST_AND_SOUTH_WEST_ARROW),
    '⤣' => Relation(symbol::NORTH_WEST_ARROW_WITH_HOOK),
    '⤤' => Relation(symbol::NORTH_EAST_ARROW_WITH_HOOK),
    '⤥' => Relation(symbol::SOUTH_EAST_ARROW_WITH_HOOK),
    '⤦' => Relation(symbol::SOUTH_WEST_ARROW_WITH_HOOK),
    '⤧' => Relation(symbol::NORTH_WEST_ARROW_AND_NORTH_EAST_ARROW),
    '⤨' => Relation(symbol::NORTH_EAST_ARROW_AND_SOUTH_EAST_ARROW),
    '⤩' => Relation(symbol::SOUTH_EAST_ARROW_AND_SOUTH_WEST_ARROW),
    '⤪' => Relation(symbol::SOUTH_WEST_ARROW_AND_NORTH_WEST_ARROW),
    '⤫' => Relation(symbol::RISING_DIAGONAL_CROSSING_FALLING_DIAGONAL),
    '⤬' => Relation(symbol::FALLING_DIAGONAL_CROSSING_RISING_DIAGONAL),
    '⤭' => Relation(symbol::SOUTH_EAST_ARROW_CROSSING_NORTH_EAST_ARROW),
    '⤮' => Relation(symbol::NORTH_EAST_ARROW_CROSSING_SOUTH_EAST_ARROW),
    '⤯' => Relation(symbol::FALLING_DIAGONAL_CROSSING_NORTH_EAST_ARROW),
    '⤰' => Relation(symbol::RISING_DIAGONAL_CROSSING_SOUTH_EAST_ARROW),
    '⤱' => Relation(symbol::NORTH_EAST_ARROW_CROSSING_NORTH_WEST_ARROW),
    '⤲' => Relation(symbol::NORTH_WEST_ARROW_CROSSING_NORTH_EAST_ARROW),
    '⤳' => Relation(symbol::WAVE_ARROW_POINTING_DIRECTLY_RIGHT),
    '⤴' => Relation(symbol::ARROW_POINTING_RIGHTWARDS_THEN_CURVING_UPWARDS),
    '⤵' => Relation(symbol::ARROW_POINTING_RIGHTWARDS_THEN_CURVING_DOWNWARDS),
    '⤶' => Relation(symbol::ARROW_POINTING_DOWNWARDS_THEN_CURVING_LEFTWARDS),
    '⤷' => Relation(symbol::ARROW_POINTING_DOWNWARDS_THEN_CURVING_RIGHTWARDS),
    '⤸' => Relation(symbol::RIGHT_SIDE_ARC_CLOCKWISE_ARROW),
    '⤹' => Relation(symbol::LEFT_SIDE_ARC_ANTICLOCKWISE_ARROW),
    '⤺' => Relation(symbol::TOP_ARC_ANTICLOCKWISE_ARROW),
    '⤻' => Relation(symbol::BOTTOM_ARC_ANTICLOCKWISE_ARROW),
    '⤼' => Relation(symbol::TOP_ARC_CLOCKWISE_ARROW_WITH_MINUS),
    '⤽' => Relation(symbol::TOP_ARC_ANTICLOCKWISE_ARROW_WITH_PLUS),
    '⤾' => Relation(symbol::LOWER_RIGHT_SEMICIRCULAR_CLOCKWISE_ARROW),
    '⤿' => Relation(symbol::LOWER_LEFT_SEMICIRCULAR_ANTICLOCKWISE_ARROW),
    '⥀' => Relation(symbol::ANTICLOCKWISE_CLOSED_CIRCLE_ARROW),
    '⥁' => Relation(symbol::CLOCKWISE_CLOSED_CIRCLE_ARROW),
    '⥂' => Relation(symbol::RIGHTWARDS_ARROW_ABOVE_SHORT_LEFTWARDS_ARROW),
    '⥃' => Relation(symbol::LEFTWARDS_ARROW_ABOVE_SHORT_RIGHTWARDS_ARROW),
    '⥄' => Relation(symbol::SHORT_RIGHTWARDS_ARROW_ABOVE_LEFTWARDS_ARROW),
    '⥅' => Relation(symbol::RIGHTWARDS_ARROW_WITH_PLUS_BELOW),
    '⥆' => Relation(symbol::LEFTWARDS_ARROW_WITH_PLUS_BELOW),
    '⥇' => Relation(symbol::RIGHTWARDS_ARROW_THROUGH_X),
    '⥈' => Relation(symbol::LEFT_RIGHT_ARROW_THROUGH_SMALL_CIRCLE),
    '⥉' => Relation(symbol::UPWARDS_TWO_HEADED_ARROW_FROM_SMALL_CIRCLE),
    '⥊' => Relation(symbol::LEFT_BARB_UP_RIGHT_BARB_DOWN_HARPOON),
    '⥋' => Relation(symbol::LEFT_BARB_DOWN_RIGHT_BARB_UP_HARPOON),
    '⥌' => Relation(symbol::UP_BARB_RIGHT_DOWN_BARB_LEFT_HARPOON),
    '⥍' => Relation(symbol::UP_BARB_LEFT_DOWN_BARB_RIGHT_HARPOON),
    '⥎' => Relation(symbol::LEFT_BARB_UP_RIGHT_BARB_UP_HARPOON),
    '⥏' => Relation(symbol::UP_BARB_RIGHT_DOWN_BARB_RIGHT_HARPOON),
    '⥐' => Relation(symbol::LEFT_BARB_DOWN_RIGHT_BARB_DOWN_HARPOON),
    '⥑' => Relation(symbol::UP_BARB_LEFT_DOWN_BARB_LEFT_HARPOON),
    '⥒' => Relation(symbol::LEFTWARDS_HARPOON_WITH_BARB_UP_TO_BAR),
    '⥓' => Relation(symbol::RIGHTWARDS_HARPOON_WITH_BARB_UP_TO_BAR),
    '⥔' => Relation(symbol::UPWARDS_HARPOON_WITH_BARB_RIGHT_TO_BAR),
    '⥕' => Relation(symbol::DOWNWARDS_HARPOON_WITH_BARB_RIGHT_TO_BAR),
    '⥖' => Relation(symbol::LEFTWARDS_HARPOON_WITH_BARB_DOWN_TO_BAR),
    '⥗' => Relation(symbol::RIGHTWARDS_HARPOON_WITH_BARB_DOWN_TO_BAR),
    '⥘' => Relation(symbol::UPWARDS_HARPOON_WITH_BARB_LEFT_TO_BAR),
    '⥙' => Relation(symbol::DOWNWARDS_HARPOON_WITH_BARB_LEFT_TO_BAR),
    '⥚' => Relation(symbol::LEFTWARDS_HARPOON_WITH_BARB_UP_FROM_BAR),
    '⥛' => Relation(symbol::RIGHTWARDS_HARPOON_WITH_BARB_UP_FROM_BAR),
    '⥜' => Relation(symbol::UPWARDS_HARPOON_WITH_BARB_RIGHT_FROM_BAR),
    '⥝' => Relation(symbol::DOWNWARDS_HARPOON_WITH_BARB_RIGHT_FROM_BAR),
    '⥞' => Relation(symbol::LEFTWARDS_HARPOON_WITH_BARB_DOWN_FROM_BAR),
    '⥟' => Relation(symbol::RIGHTWARDS_HARPOON_WITH_BARB_DOWN_FROM_BAR),
    '⥠' => Relation(symbol::UPWARDS_HARPOON_WITH_BARB_LEFT_FROM_BAR),
    '⥡' => Relation(symbol::DOWNWARDS_HARPOON_WITH_BARB_LEFT_FROM_BAR),
    '⥢' => Relation(symbol::LEFTWARDS_HARPOON_WITH_BARB_UP_ABOVE_LEFTWARDS_HARPOON_WITH_BARB_DOWN),
    '⥣' => Relation(symbol::UPWARDS_HARPOON_WITH_BARB_LEFT_BESIDE_UPWARDS_HARPOON_WITH_BARB_RIGHT),
    '⥤' => Relation(symbol::RIGHTWARDS_HARPOON_WITH_BARB_UP_ABOVE_RIGHTWARDS_HARPOON_WITH_BARB_DOWN),
    '⥥' => Relation(symbol::DOWNWARDS_HARPOON_WITH_BARB_LEFT_BESIDE_DOWNWARDS_HARPOON_WITH_BARB_RIGHT),
    '⥦' => Relation(symbol::LEFTWARDS_HARPOON_WITH_BARB_UP_ABOVE_RIGHTWARDS_HARPOON_WITH_BARB_UP),
    '⥧' => Relation(symbol::LEFTWARDS_HARPOON_WITH_BARB_DOWN_ABOVE_RIGHTWARDS_HARPOON_WITH_BARB_DOWN),
    '⥨' => Relation(symbol::RIGHTWARDS_HARPOON_WITH_BARB_UP_ABOVE_LEFTWARDS_HARPOON_WITH_BARB_UP),
    '⥩' => Relation(symbol::RIGHTWARDS_HARPOON_WITH_BARB_DOWN_ABOVE_LEFTWARDS_HARPOON_WITH_BARB_DOWN),
    '⥪' => Relation(symbol::LEFTWARDS_HARPOON_WITH_BARB_UP_ABOVE_LONG_DASH),
    '⥫' => Relation(symbol::LEFTWARDS_HARPOON_WITH_BARB_DOWN_BELOW_LONG_DASH),
    '⥬' => Relation(symbol::RIGHTWARDS_HARPOON_WITH_BARB_UP_ABOVE_LONG_DASH),
    '⥭' => Relation(symbol::RIGHTWARDS_HARPOON_WITH_BARB_DOWN_BELOW_LONG_DASH),
    '⥮' => Relation(symbol::UPWARDS_HARPOON_WITH_BARB_LEFT_BESIDE_DOWNWARDS_HARPOON_WITH_BARB_RIGHT),
    '⥯' => Relation(symbol::DOWNWARDS_HARPOON_WITH_BARB_LEFT_BESIDE_UPWARDS_HARPOON_WITH_BARB_RIGHT),
    '⥰' => Relation(symbol::RIGHT_DOUBLE_ARROW_WITH_ROUNDED_HEAD),
    '⥱' => Relation(symbol::EQUALS_SIGN_ABOVE_RIGHTWARDS_ARROW),
    '⥲' => Relation(symbol::TILDE_OPERATOR_ABOVE_RIGHTWARDS_ARROW),
    '⥳' => Relation(symbol::LEFTWARDS_ARROW_ABOVE_TILDE_OPERATOR),
    '⥴' => Relation(symbol::RIGHTWARDS_ARROW_ABOVE_TILDE_OPERATOR),
    '⥵' => Relation(symbol::RIGHTWARDS_ARROW_ABOVE_ALMOST_EQUAL_TO),
    '⥶' => Relation(symbol::LESS_THAN_ABOVE_LEFTWARDS_ARROW),
    '⥷' => Relation(symbol::LEFTWARDS_ARROW_THROUGH_LESS_THAN),
    '⥸' => Relation(symbol::GREATER_THAN_ABOVE_RIGHTWARDS_ARROW),
    '⥹' => Relation(symbol::SUBSET_ABOVE_RIGHTWARDS_ARROW),
    '⥺' => Relation(symbol::LEFTWARDS_ARROW_THROUGH_SUBSET),
    '⥻' => Relation(symbol::SUPERSET_ABOVE_LEFTWARDS_ARROW),
    '⥼' => Relation(symbol::LEFT_FISH_TAIL),
    '⥽' => Relation(symbol::RIGHT_FISH_TAIL),
    '⥾' => Relation(symbol::UP_FISH_TAIL),
    '⥿' => Relation(symbol::DOWN_FISH_TAIL),
    '⦂' => Relation(symbol::Z_NOTATION_TYPE_COLON),
    '⧎' => Relation(symbol::RIGHT_TRIANGLE_ABOVE_LEFT_TRIANGLE),
    '⧏' => Relation(symbol::LEFT_TRIANGLE_BESIDE_VERTICAL_BAR),
    '⧐' => Relation(symbol::VERTICAL_BAR_BESIDE_RIGHT_TRIANGLE),
    '⧑' => Relation(symbol::BOWTIE_WITH_LEFT_HALF_BLACK),
    '⧒' => Relation(symbol::BOWTIE_WITH_RIGHT_HALF_BLACK),
    '⧓' => Relation(symbol::BLACK_BOWTIE),
    '⧔' => ForceRelation(symbol::TIMES_WITH_LEFT_HALF_BLACK.as_op()),
    '⧕' => ForceRelation(symbol::TIMES_WITH_RIGHT_HALF_BLACK.as_op()),
    '⧟' => Relation(symbol::DOUBLE_ENDED_MULTIMAP),
    '⧠' => Relation(symbol::SQUARE_WITH_CONTOURED_OUTLINE),
    '⧡' => Relation(symbol::INCREASES_AS),
    '⧣' => Relation(symbol::EQUALS_SIGN_AND_SLANTED_PARALLEL),
    '⧤' => Relation(symbol::EQUALS_SIGN_AND_SLANTED_PARALLEL_WITH_TILDE_ABOVE),
    '⧥' => Relation(symbol::IDENTICAL_TO_AND_SLANTED_PARALLEL),
    '⧦' => Relation(symbol::GLEICH_STARK),
    '⧴' => Relation(symbol::RULE_DELAYED),
    '⩦' => Relation(symbol::EQUALS_SIGN_WITH_DOT_BELOW),
    '⩧' => Relation(symbol::IDENTICAL_WITH_DOT_ABOVE),
    '⩨' => Relation(symbol::TRIPLE_HORIZONTAL_BAR_WITH_DOUBLE_VERTICAL_STROKE),
    '⩩' => Relation(symbol::TRIPLE_HORIZONTAL_BAR_WITH_TRIPLE_VERTICAL_STROKE),
    '⩪' => Relation(symbol::TILDE_OPERATOR_WITH_DOT_ABOVE),
    '⩫' => Relation(symbol::TILDE_OPERATOR_WITH_RISING_DOTS),
    '⩬' => Relation(symbol::SIMILAR_MINUS_SIMILAR),
    '⩭' => Relation(symbol::CONGRUENT_WITH_DOT_ABOVE),
    '⩮' => Relation(symbol::EQUALS_WITH_ASTERISK),
    '⩯' => Relation(symbol::ALMOST_EQUAL_TO_WITH_CIRCUMFLEX_ACCENT),
    '⩰' => Relation(symbol::APPROXIMATELY_EQUAL_OR_EQUAL_TO),
    '⩱' => Relation(symbol::EQUALS_SIGN_ABOVE_PLUS_SIGN),
    '⩲' => Relation(symbol::PLUS_SIGN_ABOVE_EQUALS_SIGN),
    '⩳' => Relation(symbol::EQUALS_SIGN_ABOVE_TILDE_OPERATOR),
    '⩴' => Relation(symbol::DOUBLE_COLON_EQUAL),
    '⩵' => Relation(symbol::TWO_CONSECUTIVE_EQUALS_SIGNS),
    '⩶' => Relation(symbol::THREE_CONSECUTIVE_EQUALS_SIGNS),
    '⩷' => Relation(symbol::EQUALS_SIGN_WITH_TWO_DOTS_ABOVE_AND_TWO_DOTS_BELOW),
    '⩸' => Relation(symbol::EQUIVALENT_WITH_FOUR_DOTS_ABOVE),
    '⩹' => Relation(symbol::LESS_THAN_WITH_CIRCLE_INSIDE),
    '⩺' => Relation(symbol::GREATER_THAN_WITH_CIRCLE_INSIDE),
    '⩻' => Relation(symbol::LESS_THAN_WITH_QUESTION_MARK_ABOVE),
    '⩼' => Relation(symbol::GREATER_THAN_WITH_QUESTION_MARK_ABOVE),
    '⩽' => Relation(symbol::LESS_THAN_OR_SLANTED_EQUAL_TO),
    '⩾' => Relation(symbol::GREATER_THAN_OR_SLANTED_EQUAL_TO),
    '⩿' => Relation(symbol::LESS_THAN_OR_SLANTED_EQUAL_TO_WITH_DOT_INSIDE),
    '⪀' => Relation(symbol::GREATER_THAN_OR_SLANTED_EQUAL_TO_WITH_DOT_INSIDE),
    '⪁' => Relation(symbol::LESS_THAN_OR_SLANTED_EQUAL_TO_WITH_DOT_ABOVE),
    '⪂' => Relation(symbol::GREATER_THAN_OR_SLANTED_EQUAL_TO_WITH_DOT_ABOVE),
    '⪃' => Relation(symbol::LESS_THAN_OR_SLANTED_EQUAL_TO_WITH_DOT_ABOVE_RIGHT),
    '⪄' => Relation(symbol::GREATER_THAN_OR_SLANTED_EQUAL_TO_WITH_DOT_ABOVE_LEFT),
    '⪅' => Relation(symbol::LESS_THAN_OR_APPROXIMATE),
    '⪆' => Relation(symbol::GREATER_THAN_OR_APPROXIMATE),
    '⪇' => Relation(symbol::LESS_THAN_AND_SINGLE_LINE_NOT_EQUAL_TO),
    '⪈' => Relation(symbol::GREATER_THAN_AND_SINGLE_LINE_NOT_EQUAL_TO),
    '⪉' => Relation(symbol::LESS_THAN_AND_NOT_APPROXIMATE),
    '⪊' => Relation(symbol::GREATER_THAN_AND_NOT_APPROXIMATE),
    '⪋' => Relation(symbol::LESS_THAN_ABOVE_DOUBLE_LINE_EQUAL_ABOVE_GREATER_THAN),
    '⪌' => Relation(symbol::GREATER_THAN_ABOVE_DOUBLE_LINE_EQUAL_ABOVE_LESS_THAN),
    '⪍' => Relation(symbol::LESS_THAN_ABOVE_SIMILAR_OR_EQUAL),
    '⪎' => Relation(symbol::GREATER_THAN_ABOVE_SIMILAR_OR_EQUAL),
    '⪏' => Relation(symbol::LESS_THAN_ABOVE_SIMILAR_ABOVE_GREATER_THAN),
    '⪐' => Relation(symbol::GREATER_THAN_ABOVE_SIMILAR_ABOVE_LESS_THAN),
    '⪑' => Relation(symbol::LESS_THAN_ABOVE_GREATER_THAN_ABOVE_DOUBLE_LINE_EQUAL),
    '⪒' => Relation(symbol::GREATER_THAN_ABOVE_LESS_THAN_ABOVE_DOUBLE_LINE_EQUAL),
    '⪓' => Relation(symbol::LESS_THAN_ABOVE_SLANTED_EQUAL_ABOVE_GREATER_THAN_ABOVE_SLANTED_EQUAL),
    '⪔' => Relation(symbol::GREATER_THAN_ABOVE_SLANTED_EQUAL_ABOVE_LESS_THAN_ABOVE_SLANTED_EQUAL),
    '⪕' => Relation(symbol::SLANTED_EQUAL_TO_OR_LESS_THAN),
    '⪖' => Relation(symbol::SLANTED_EQUAL_TO_OR_GREATER_THAN),
    '⪗' => Relation(symbol::SLANTED_EQUAL_TO_OR_LESS_THAN_WITH_DOT_INSIDE),
    '⪘' => Relation(symbol::SLANTED_EQUAL_TO_OR_GREATER_THAN_WITH_DOT_INSIDE),
    '⪙' => Relation(symbol::DOUBLE_LINE_EQUAL_TO_OR_LESS_THAN),
    '⪚' => Relation(symbol::DOUBLE_LINE_EQUAL_TO_OR_GREATER_THAN),
    '⪛' => Relation(symbol::DOUBLE_LINE_SLANTED_EQUAL_TO_OR_LESS_THAN),
    '⪜' => Relation(symbol::DOUBLE_LINE_SLANTED_EQUAL_TO_OR_GREATER_THAN),
    '⪝' => Relation(symbol::SIMILAR_OR_LESS_THAN),
    '⪞' => Relation(symbol::SIMILAR_OR_GREATER_THAN),
    '⪟' => Relation(symbol::SIMILAR_ABOVE_LESS_THAN_ABOVE_EQUALS_SIGN),
    '⪠' => Relation(symbol::SIMILAR_ABOVE_GREATER_THAN_ABOVE_EQUALS_SIGN),
    '⪡' => Relation(symbol::DOUBLE_NESTED_LESS_THAN),
    '⪢' => Relation(symbol::DOUBLE_NESTED_GREATER_THAN),
    '⪣' => Relation(symbol::DOUBLE_NESTED_LESS_THAN_WITH_UNDERBAR),
    '⪤' => Relation(symbol::GREATER_THAN_OVERLAPPING_LESS_THAN),
    '⪥' => Relation(symbol::GREATER_THAN_BESIDE_LESS_THAN),
    '⪦' => Relation(symbol::LESS_THAN_CLOSED_BY_CURVE),
    '⪧' => Relation(symbol::GREATER_THAN_CLOSED_BY_CURVE),
    '⪨' => Relation(symbol::LESS_THAN_CLOSED_BY_CURVE_ABOVE_SLANTED_EQUAL),
    '⪩' => Relation(symbol::GREATER_THAN_CLOSED_BY_CURVE_ABOVE_SLANTED_EQUAL),
    '⪪' => Relation(symbol::SMALLER_THAN),
    '⪫' => Relation(symbol::LARGER_THAN),
    '⪬' => Relation(symbol::SMALLER_THAN_OR_EQUAL_TO),
    '⪭' => Relation(symbol::LARGER_THAN_OR_EQUAL_TO),
    '⪮' => Relation(symbol::EQUALS_SIGN_WITH_BUMPY_ABOVE),
    '⪯' => Relation(symbol::PRECEDES_ABOVE_SINGLE_LINE_EQUALS_SIGN),
    '⪰' => Relation(symbol::SUCCEEDS_ABOVE_SINGLE_LINE_EQUALS_SIGN),
    '⪱' => Relation(symbol::PRECEDES_ABOVE_SINGLE_LINE_NOT_EQUAL_TO),
    '⪲' => Relation(symbol::SUCCEEDS_ABOVE_SINGLE_LINE_NOT_EQUAL_TO),
    '⪳' => Relation(symbol::PRECEDES_ABOVE_EQUALS_SIGN),
    '⪴' => Relation(symbol::SUCCEEDS_ABOVE_EQUALS_SIGN),
    '⪵' => Relation(symbol::PRECEDES_ABOVE_NOT_EQUAL_TO),
    '⪶' => Relation(symbol::SUCCEEDS_ABOVE_NOT_EQUAL_TO),
    '⪷' => Relation(symbol::PRECEDES_ABOVE_ALMOST_EQUAL_TO),
    '⪸' => Relation(symbol::SUCCEEDS_ABOVE_ALMOST_EQUAL_TO),
    '⪹' => Relation(symbol::PRECEDES_ABOVE_NOT_ALMOST_EQUAL_TO),
    '⪺' => Relation(symbol::SUCCEEDS_ABOVE_NOT_ALMOST_EQUAL_TO),
    '⪻' => Relation(symbol::DOUBLE_PRECEDES),
    '⪼' => Relation(symbol::DOUBLE_SUCCEEDS),
    '⪽' => Relation(symbol::SUBSET_WITH_DOT),
    '⪾' => Relation(symbol::SUPERSET_WITH_DOT),
    '⪿' => Relation(symbol::SUBSET_WITH_PLUS_SIGN_BELOW),
    '⫀' => Relation(symbol::SUPERSET_WITH_PLUS_SIGN_BELOW),
    '⫁' => Relation(symbol::SUBSET_WITH_MULTIPLICATION_SIGN_BELOW),
    '⫂' => Relation(symbol::SUPERSET_WITH_MULTIPLICATION_SIGN_BELOW),
    '⫃' => Relation(symbol::SUBSET_OF_OR_EQUAL_TO_WITH_DOT_ABOVE),
    '⫄' => Relation(symbol::SUPERSET_OF_OR_EQUAL_TO_WITH_DOT_ABOVE),
    '⫅' => Relation(symbol::SUBSET_OF_ABOVE_EQUALS_SIGN),
    '⫆' => Relation(symbol::SUPERSET_OF_ABOVE_EQUALS_SIGN),
    '⫇' => Relation(symbol::SUBSET_OF_ABOVE_TILDE_OPERATOR),
    '⫈' => Relation(symbol::SUPERSET_OF_ABOVE_TILDE_OPERATOR),
    '⫉' => Relation(symbol::SUBSET_OF_ABOVE_ALMOST_EQUAL_TO),
    '⫊' => Relation(symbol::SUPERSET_OF_ABOVE_ALMOST_EQUAL_TO),
    '⫋' => Relation(symbol::SUBSET_OF_ABOVE_NOT_EQUAL_TO),
    '⫌' => Relation(symbol::SUPERSET_OF_ABOVE_NOT_EQUAL_TO),
    '⫍' => Relation(symbol::SQUARE_LEFT_OPEN_BOX_OPERATOR),
    '⫎' => Relation(symbol::SQUARE_RIGHT_OPEN_BOX_OPERATOR),
    '⫏' => Relation(symbol::CLOSED_SUBSET),
    '⫐' => Relation(symbol::CLOSED_SUPERSET),
    '⫑' => Relation(symbol::CLOSED_SUBSET_OR_EQUAL_TO),
    '⫒' => Relation(symbol::CLOSED_SUPERSET_OR_EQUAL_TO),
    '⫓' => Relation(symbol::SUBSET_ABOVE_SUPERSET),
    '⫔' => Relation(symbol::SUPERSET_ABOVE_SUBSET),
    '⫕' => Relation(symbol::SUBSET_ABOVE_SUBSET),
    '⫖' => Relation(symbol::SUPERSET_ABOVE_SUPERSET),
    '⫗' => Relation(symbol::SUPERSET_BESIDE_SUBSET),
    '⫘' => Relation(symbol::SUPERSET_BESIDE_AND_JOINED_BY_DASH_WITH_SUBSET),
    // ⫙
    // ⫚
    // ⫛
    // ⫝̸ (should map to decomposed form)
    // ⫝
    '⫞' => Relation(symbol::SHORT_LEFT_TACK),
    '⫟' => Relation(symbol::SHORT_DOWN_TACK),
    '⫠' => Relation(symbol::SHORT_UP_TACK),
    '⫡' => Relation(symbol::PERPENDICULAR_WITH_S),
    '⫢' => Relation(symbol::VERTICAL_BAR_TRIPLE_RIGHT_TURNSTILE),
    '⫣' => Relation(symbol::DOUBLE_VERTICAL_BAR_LEFT_TURNSTILE),
    '⫤' => Relation(symbol::VERTICAL_BAR_DOUBLE_LEFT_TURNSTILE),
    '⫥' => Relation(symbol::DOUBLE_VERTICAL_BAR_DOUBLE_LEFT_TURNSTILE),
    '⫦' => Relation(symbol::LONG_DASH_FROM_LEFT_MEMBER_OF_DOUBLE_VERTICAL),
    '⫧' => Relation(symbol::SHORT_DOWN_TACK_WITH_OVERBAR),
    '⫨' => Relation(symbol::SHORT_UP_TACK_WITH_UNDERBAR),
    '⫩' => Relation(symbol::SHORT_UP_TACK_ABOVE_SHORT_DOWN_TACK),
    '⫪' => Relation(symbol::DOUBLE_DOWN_TACK),
    '⫫' => Relation(symbol::DOUBLE_UP_TACK),
    // ⫬
    // ⫭
    '⫮' => Relation(symbol::DOES_NOT_DIVIDE_WITH_REVERSED_NEGATION_SLASH),
    // ⫯
    // ⫰
    '⫲' => Relation(symbol::PARALLEL_WITH_HORIZONTAL_STROKE),
    '⫳' => Relation(symbol::PARALLEL_WITH_TILDE_OPERATOR),
    '⫷' => Relation(symbol::TRIPLE_NESTED_LESS_THAN),
    '⫸' => Relation(symbol::TRIPLE_NESTED_GREATER_THAN),
    '⫹' => Relation(symbol::DOUBLE_LINE_SLANTED_LESS_THAN_OR_EQUAL_TO),
    '⫺' => Relation(symbol::DOUBLE_LINE_SLANTED_GREATER_THAN_OR_EQUAL_TO),
    '⬰' => Relation(symbol::LEFT_ARROW_WITH_SMALL_CIRCLE),
    '⬱' => Relation(symbol::THREE_LEFTWARDS_ARROWS),
    '⬲' => Relation(symbol::LEFT_ARROW_WITH_CIRCLED_PLUS),
    '⬳' => Relation(symbol::LONG_LEFTWARDS_SQUIGGLE_ARROW),
    '⬴' => Relation(symbol::LEFTWARDS_TWO_HEADED_ARROW_WITH_VERTICAL_STROKE),
    '⬵' => Relation(symbol::LEFTWARDS_TWO_HEADED_ARROW_WITH_DOUBLE_VERTICAL_STROKE),
    '⬶' => Relation(symbol::LEFTWARDS_TWO_HEADED_ARROW_FROM_BAR),
    '⬷' => Relation(symbol::LEFTWARDS_TWO_HEADED_TRIPLE_DASH_ARROW),
    '⬸' => Relation(symbol::LEFTWARDS_ARROW_WITH_DOTTED_STEM),
    '⬹' => Relation(symbol::LEFTWARDS_ARROW_WITH_TAIL_WITH_VERTICAL_STROKE),
    '⬺' => Relation(symbol::LEFTWARDS_ARROW_WITH_TAIL_WITH_DOUBLE_VERTICAL_STROKE),
    '⬻' => Relation(symbol::LEFTWARDS_TWO_HEADED_ARROW_WITH_TAIL),
    '⬼' => Relation(symbol::LEFTWARDS_TWO_HEADED_ARROW_WITH_TAIL_WITH_VERTICAL_STROKE),
    '⬽' => Relation(symbol::LEFTWARDS_TWO_HEADED_ARROW_WITH_TAIL_WITH_DOUBLE_VERTICAL_STROKE),
    '⬾' => Relation(symbol::LEFTWARDS_ARROW_THROUGH_X),
    '⬿' => Relation(symbol::WAVE_ARROW_POINTING_DIRECTLY_LEFT),
    '⭀' => Relation(symbol::EQUALS_SIGN_ABOVE_LEFTWARDS_ARROW),
    '⭁' => Relation(symbol::REVERSE_TILDE_OPERATOR_ABOVE_LEFTWARDS_ARROW),
    '⭂' => Relation(symbol::LEFTWARDS_ARROW_ABOVE_REVERSE_ALMOST_EQUAL_TO),
    '⭃' => Relation(symbol::RIGHTWARDS_ARROW_THROUGH_GREATER_THAN),
    '⭄' => Relation(symbol::RIGHTWARDS_ARROW_THROUGH_SUPERSET),
    '⭅' => Relation(symbol::LEFTWARDS_QUADRUPLE_ARROW),
    '⭆' => Relation(symbol::RIGHTWARDS_QUADRUPLE_ARROW),
    '⭇' => Relation(symbol::REVERSE_TILDE_OPERATOR_ABOVE_RIGHTWARDS_ARROW),
    '⭈' => Relation(symbol::RIGHTWARDS_ARROW_ABOVE_REVERSE_ALMOST_EQUAL_TO),
    '⭉' => Relation(symbol::TILDE_OPERATOR_ABOVE_LEFTWARDS_ARROW),
    '⭊' => Relation(symbol::LEFTWARDS_ARROW_ABOVE_ALMOST_EQUAL_TO),
    '⭋' => Relation(symbol::LEFTWARDS_ARROW_ABOVE_REVERSE_TILDE_OPERATOR),
