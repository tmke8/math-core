...
static COMMANDS: phf::Map<&'static str, Token> = phf::phf_map! {
    ...
    "Coloneq" => CompositeRelation {
        combined: symbol::DOUBLE_COLON_EQUAL.as_bmp_op(),
        rel_category: RelCategory::Default,
        parts: &predefined::DOUBLE_COLON_EQUAL,
    },
    "Coloneqq" => CompositeRelation {
        combined: symbol::DOUBLE_COLON_EQUAL.as_bmp_op(),
        rel_category: RelCategory::Default,
        parts: &predefined::DOUBLE_COLON_EQUAL,
    },
    ...
    "Overrightarrow" => Accent(symbol::RIGHTWARDS_DOUBLE_ARROW.as_op(), true, OpAttrs::empty()),
    ...
    "coloneq" => CompositeRelation {
        combined: symbol::COLON_EQUALS.as_bmp_op(),
        rel_category: RelCategory::Default,
        parts: &predefined::COLON_EQUALS,
    },
    ...
    "dashcolon" => CompositeRelation {
        combined: symbol::EXCESS.as_bmp_op(),
        rel_category: RelCategory::Default,
        parts: &predefined::MINUS_COLON,
    },
    ...
    "dblcolon" => CompositeRelation {
        combined: symbol::PROPORTION.as_bmp_op(),
        rel_category: RelCategory::Default,
        parts: &predefined::DOUBLE_COLON,
    },
    ...
    "eqcolon" => CompositeRelation {
        combined: symbol::EQUALS_COLON.as_bmp_op(),
        rel_category: RelCategory::Default,
        parts: &predefined::EQUALS_COLON,
    },
    "eqdef" => Relation(symbol::EQUAL_TO_BY_DEFINITION), // from "stix"
    "eqqcolon" => CompositeRelation {
        combined: symbol::EQUALS_COLON.as_bmp_op(),
        rel_category: RelCategory::Default,
        parts: &predefined::EQUALS_COLON,
    },
    ...
    "overgroup" => Accent(symbol::TOP_TORTOISE_SHELL_BRACKET.as_op(), true, OpAttrs::empty()),
    "overleftarrow" => Accent(symbol::LEFTWARDS_ARROW.as_op(), true, OpAttrs::empty()),
    "overleftharpoon" => Accent(symbol::LEFTWARDS_HARPOON_WITH_BARB_UPWARDS.as_op(), true, OpAttrs::empty()),
    "overleftrightarrow" => Accent(symbol::LEFT_RIGHT_ARROW.as_op(), true, OpAttrs::empty()),
    ...
    "overrightharpoon" => Accent(symbol::RIGHTWARDS_HARPOON_WITH_BARB_UPWARDS.as_op(), true, OpAttrs::empty()),
    "overset" => Overset,
    ...
    "undergroup" => Accent(symbol::BOTTOM_TORTOISE_SHELL_BRACKET.as_op(), false, OpAttrs::empty()),
    "underleftarrow" => Accent(symbol::LEFTWARDS_ARROW.as_op(), false, OpAttrs::empty()),
    "underleftrightarrow" => Accent(symbol::LEFT_RIGHT_ARROW.as_op(), false, OpAttrs::empty()),
    "underrightarrow" => Accent(symbol::RIGHTWARDS_ARROW.as_op(), false, OpAttrs::empty()),
