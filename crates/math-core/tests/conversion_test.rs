...
fn main() {
    let problems = [
        ...
        ("phantom", r"\sqrt{\phantom{x}y}"),
        ("hphantom", r"\sqrt{\hphantom{x}y}"),
        ("vphantom", r"\sqrt{\vphantom{x}y}"),
        ("greater_than", r"x > y"),
        ...
        ("kern", r"x\kern1em y"),
        ("kern_no_trailing_space", r"x\kern1.5emx"),
        ("kern_decimal_comma", r"x\kern1,5em y"),
        ("kern_leading_dot", r"x\kern.5em y"),
        ("kern_plus_sign", r"x\kern+2pt y"),
        ("kern_space_before_number", r"x\kern 1em y"),
        ("kern_space_before_unit", r"x\kern1 em y"),
        ("kern_negative", r"x\kern-1em y"),
        ("hskip", r"x\hskip1em y"),
        ("hskip_negative", r"x\hskip-1em y"),
        ("mkern", r"x\mkern9mu y"),
        ("mkern_negative", r"x\mkern-9mu y"),
